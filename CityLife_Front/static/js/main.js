...
!function () {
  ...
  if (e) {
    var n = new Image, s = "BSCompany_" + (t ? "mobile" : "pc") + "_" + (i ? "isCheck" : "notCheck");
    n.src = "https://t.zhipin.com/f.gif?pk=" + s + "&r=" + encodeURIComponent(document.referrer)
  }
}();
var KZ = KZ || {};
KZ = {
  ...
  cWidth: 350, cHeight: 350, cR: 175, show: function (e) {
    ...
    this.html || (this.html = e || $('<div class="avatar_layer avatar_layer_html5">\t\t\t\t\t\t\t\t<div class="hd"><span/><i class="close"/></div>\t\t\t\t\t\t\t\t<div class="main">\t\t\t\t\t\t\t\t\t<div class="selectpic">\t\t\t\t\t\t\t\t\t\t<div class="sbox">\t\t\t\t\t\t\t\t\t\t\t<a class="btns" href="#">选择图片</a>\t\t\t\t\t\t\t\t\t\t\t<input type="file" class="selectfile">\t\t\t\t\t\t\t\t\t\t\t<p>只支持JPG、PNG，大小不超过2M</p>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t<div class="editbox">\t\t\t\t\t\t\t\t\t\t\t<canvas></canvas>\t\t\t\t\t\t\t\t\t\t\t<div class="pop"><i></i></div>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<div class="layer_btns">\t\t\t\t\t\t\t\t\t\t<span class="change">更换图片<input type="file" class="selectfile"></span>\t\t\t\t\t\t\t\t\t\t<a class="cancel close" href="#">取 消</a>\t\t\t\t\t\t\t\t\t\t<a class="sure"  href="#" ka="avatar_layer_html5_button_sure">确 定</a>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>'), this.html.appendTo("body"), e ? (t.html.find(".img-box").on("click", function () {
      ...
      if (t.target.files.length) {
        ...
        if (!/image\/\w+/.test(i.type)) return alert("请确保文件为图像类型"), !1;
...
if (function (e) {
  ...
  i.prototype = {
    constructor: i, _events: [], _attachEvents: function () {
      ...
      var e, t = !1;
      arguments && arguments.length && ("string" == typeof arguments[0] || arguments[0] instanceof Date) ? (e = arguments[0], t = !0) : ("string" == typeof (e = (this.isInput ? this.element.val() : this.element.find("input").val()) || this.element.data("date") || this.initialDate) || e instanceof String) && (e = e.replace(/^\s+|\s+$/g, "")), e || (e = new Date, t = !1), this.date = s.parseDate(e, this.format, this.language, this.formatType), t && this.setValue(), this.date < this.startDate ? this.viewDate = new Date(this.startDate) : this.date > this.endDate ? this.viewDate = new Date(this.endDate) : this.viewDate = new Date(this.date),
        this.fill()
    }, fillDow: function () {
      ...
      if (null != this.date && null != this.viewDate) {
        ...
        if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(n[this.language].months[o] + " " + a), "time" == this.formatViewType) {
          var g = c % 12 ? c % 12 : 12, v = (g < 10 ? "0" : "") + g, y = (l < 10 ? "0" : "") + l,
            w = n[this.language].meridiem[c < 12 ? 0 : 1];
          this.picker.find(".datetimepicker-hours thead th:eq(1)").text(v + ":" + y + " " + (w ? w.toUpperCase() : "")), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(v + ":" + y + " " + (w ? w.toUpperCase() : ""))
        ...
        var z = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
        a -= 1;
        for (var I = -1; I < 11; I++) {
          var O = a;
          if (this.minLimitYear && a < this.minLimitYear) return;
          this.minLimitYear && a == this.minLimitYear && (O = a + 1 + "以前"), k += '<span class="year' + (-1 == I || 10 == I ? " old" : "") + (A == a ? " active" : "") + (a < d || a > u ? " disabled" : "") + '" data-year="' + a + '">' + O + "</span>", a += 1
        }
      ...
      var e = new Date(this.viewDate), t = e.getUTCFullYear(), i = e.getUTCMonth(), n = e.getUTCDate(),
        s = e.getUTCHours(), a = this.picker.find(".datetimepicker-years").find(".year").last().hasClass("disabled");
      ...
      if (n.is(".glyphicon") && (n = e(n).parent().closest("span, td, th, legend")), 1 == n.length) {
        ...
        switch (n[0].nodeName.toLowerCase()) {
          ...
          case"span":
            if (!n.is(".disabled")) {
              var o = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(), c = this.viewDate.getUTCDate(),
                l = this.viewDate.getUTCHours(), d = this.viewDate.getUTCMinutes(), p = this.viewDate.getUTCSeconds();
              if (n.is(".month") ? (this.viewDate.setUTCDate(1), r = n.parent().find("span").index(n), c = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(r), this.element.trigger({
                type: "changeMonth",
                date: this.viewDate
              }), this.viewSelect >= 3 && this._setDate(t(o, r, c, l, d, p, 0))) : n.is(".year") ? (this.viewDate.setUTCDate(1), o = parseInt(n.text(), 10) || 0, n.text().indexOf("以前") > -1 && (o -= 1), this.viewDate.setUTCFullYear(o), this.element.trigger({
                type: "changeYear",
                date: this.viewDate
          ...
          case"td":
            if (n.is(".day") && !n.is(".disabled")) {
              var c = parseInt(n.text(), 10) || 1, o = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(),
                l = this.viewDate.getUTCHours(), d = this.viewDate.getUTCMinutes(), p = this.viewDate.getUTCSeconds();
  ...
  var n = e.fn.datetimepicker.dates = {
    ...
    parseDate: function (s, a, o, r) {
      ...
      if (y.M = y.MM = y.mm = y.m, y.dd = y.d, y.P = y.p, s = t(s.getFullYear(), s.getMonth(), s.getDate(), s.getHours(), s.getMinutes(), s.getSeconds()), u.length == a.parts.length) {
        for (var h = 0, w = a.parts.length; h < w; h++) {
  ...
  e.support.fileInput = !(new RegExp("(Android (1\\.[0156]|2\\.[01]))|(Windows Phone (OS 7|8\\.0))|(XBLWP)|(ZuneWP)|(WPDesktop)|(w(eb)?OSBrowser)|(webOS)|(Kindle/(1\\.0|2\\.[05]|3\\.0))").test(window.navigator.userAgent) || e('<input type="file"/>').prop("disabled")), e.support.xhrFileUpload = !(!window.ProgressEvent || !window.FileReader), e.support.xhrFormDataFileUpload = !!window.FormData, e.support.blobSlice = window.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice), e.widget("blueimp.fileupload", {
    ...
    _chunkedUpload: function (t, i) {
      ...
      var n, s, a = this, o = t.files[0], r = o.size, c = t.uploadedBytes, l = t.maxChunkSize || r, d = this._blobSlice,
        p = e.Deferred(), u = p.promise();
    ...
    _onAdd: function (t, i) {
      var n, s, a, o, r = this, c = !0, l = e.extend({}, this.options, i), d = i.files, p = d.length,
        u = l.limitMultiFileUploads, h = l.limitMultiFileUploadSize, f = l.limitMultiFileUploadSizeOverhead, m = 0,
        g = this._getParamName(l), v = 0;
      if (!p) return !1;
...
!function (e) {
  ...
  function n() {
    this.defaultData = [{code: "100000", name: "技术"}, {code: "", name: ""}, {
      code: "",
      name: ""
  ...
  n.prototype = {
    init: function (t) {
      ...
      if (!t) return !1;
      var s = n.find("li").length, a = e(t).index(), o = a > 4 ? a - 4 : 0, r = "down" == i && (o < s - 4 || 0 === a),
        c = "up" == i && (a < s - 5 || a == s - 1);
      ...
      var i = e(t).parents(".js-two"), n = e(".js-two"), s = e(".js-li"), a = this.getThreeData(e(t).attr("data-code")),
...
var Payment = function () {
  function e(e) {
    var e = $.extend({
      article: "", text: "", cancelText: !1, confirmText: "确定", close: function () {
      }, confirm: function () {
      }
    }, e);
    $.dialog({
  ...
  function t(e) {
    var e = $.extend({
      article: "", text: "", confirmText: "确定", close: function () {
      }, confirm: function () {
      }
    }, e), t = function () {
  ...
  function i(e, t, i) {
    ...
    var t = $.extend({
      ...
      $(".pop-payment .PaymentCheck").html('<i class="loader-gray-17"></i>正在查询支付结果，请稍后'), o.get.queryStatus(e, a).then(function (e) {
        if (1 !== e.zpData.state) {
  ...
  function n(e, t) {
    var i, n = {
      ...
      i = this, s.on("click", ".prop-order-type p", function () {
        ...
        $(this).hasClass("selected") ? (e.coupon = i.offAmount, e.discountId = i.discountId, n.text(i.discountDesc), s.find(".coupon-selected").text("-" + e.coupon + "直豆").show()) : (e.coupon = 0, e.discountId = "0", n.html("&nbsp;"), s.find(".coupon-selected").text(e.userCouponList.length + "张可用"));
        var a = e.amount, o = 100 * e.coupon + e.totalOffAmount, r = e.amount - e.balance - o,
          c = a > o + e.balance ? r : e.amount - o;
        e.pay = c, e.cost = r, e.cost <= 0 && (e.data.payType = 4), s.find(".pay-amount").text(e.pay / 100 + "直豆"), e.cost > 0 || e.recharge ? (s.find(".prop-order-type").show(), s.find(".btn-block").hide()) : (s.find(".btn-block").show(), s.find(".prop-order-type").hide())
  ...
  function s(e, t) {
    var n = {type: "wx", name: "微信支付", pay: e.pay, qrCode: e.qrCode};
    i(e, t, r.pay(n)), __conversion("payment_wx")
  }

  function a(e, t) {
    var n = {type: "zfb", name: "支付宝", pay: e.pay, qrCode: e.qrCode};
  ...
  return o.get = {}, o.post = {}, o.post.orderInfo = function (e, t) {
    ...
    var i = $.Deferred(), n = "/wapi/zpp/user/bzbOrder",
      s = {discountParam: e.discountParam, bzbParam: e.bzbParam, discountId: e.discountId, bzbChannel: e.data.payType};
  ...
  function e(e, t, i) {
    Payment.success({
      article: e || "购买成功", text: t || "", confirm: function () {
        i.confirm && i.confirm()
      }, close: function () {
        i.close && i.close()
      }
  ...
  function t(t, i, n) {
    ...
    var s = n.action ? n.action : "发布", a = {
      ...
      ordinary: {1: "火爆职位-普通版", 2: "", 3: "火爆职位-普通版", 4: "火爆职位-普通版"},
      carefree: {1: "火爆职位-畅聊版", 2: "", 3: "火爆职位-畅聊版", 4: "火爆职位-畅聊版"},
      experience: {1: "火爆职位", 2: "", 3: "", 4: "", 5: "火爆职位"}
    }, r = {
      0: {
    ...
    (n.item.combos && n.item.combos.activityType || n.item.activityType) && (l += '<ul class="vip-promotion-2018-notice"><li>1.活动截止时间2019年1月1日,超出活动时间范围，购买的商品不再享受活动折扣</li><li>2.本次优惠活动仅针对部分用户,最终解释权归BOSS直聘所有</li><li>3.活动期间购买的商品原则上无法申请退款,如因平台原因导致您无法使用账号的赠送时长请联系客服</li></ul>');
    var u = function (t) {
  ...
  return {
    vip: function (e, t) {
      var i = t || {}, n = function () {
        $.toast({type: "success", content: "您已成功购买VIP账号，可在VIP权益页面查看使用明细"}), i.success && i.success()
      }, s = {
      ...
      var n = 11 == i.item.business ? "普通职位" : "火爆职位", s = "";
      ...
      4 == i.item.cardId && (i.title = i.item.title, i.item.chat = i.item.chatDescList[0], i.item.inDate = i.item.chatDescList.length > 2 ? i.item.chatDescList[1] : "", i.item.view = "+" + 2 * parseInt(i.item.chat, 10) + "次");
      var r = i.item ? i.item : i, c = r.cardId, l = a[c] ? Utemplate(a[c], r) : "", d = 9 == c ? function (e) {
        ...
        if (i.success ? n = i.success : i.confirm && (n = i.confirm), 1 === t.experience) return e("免费试用火爆职位", t.dialog.content, {confirm: n}), !0;
        ...
        var s = "";
        3 == c && r.activityType && (s = '<ul class="vip-promotion-2018-notice"><li>特别注意：</li><li>1. 活动期间，每个用户只能购买一次VIP账号，不可多次购买；</li><li>2. 活动期间购买的商品原则上无法申请退款，如因平台原因导致您无法使用账号的赠送时长请联系客服；</li></ul>'), 2 == c && r.activityType && (s = '<ul class="vip-promotion-2018-notice"><li>特别注意：</li><li>1. 活动截止时间1月1日,超出活动时间范围，购买的商品不再享受活动折扣；</li><li>2. 本次优惠活动仅针对部分用户,最终解释权归BOSS直聘所有；</li><li>3. 活动期间购买的商品原则上无法申请退款如因平台原因导致您无法使用账号的赠送时长请联系客服；</li></ul>'), e(l, d + s, {confirm: n})
      }, u = {
  ...
  function t(t) {
    ...
    $.dialog({
      title: "直豆充值", content: s.rebate(function () {
        return [100, 200, 300, 500, 1e3].map(function (e) {
          return {amount: e, save: a(e, n(e)).save}
        })
      }()), confirmText: "确定充值", cancelText: !1, wrapClass: "recharge-beans-rebate", onOpen: o, onConfirm: r
    })
  }
  ...
  function i(t) {
    var i = t.discount ? .9 : 1, n = function (e) {
      var t = function (t) {
        ...
        $(e).find(".order-save").text("-￥" + n.save), $(e).find(".order-pay").text("￥" + n.pay), t ? $(e).find(".btn-sure").removeClass("disabled") : $(e).find(".btn-sure").addClass("disabled")
      };
      $(e).on("input", ".ipt-amount", function () {
...
!function (e) {
  ...
  t.prototype.init = function () {
    ...
    return this.isShowNow && i.push({name: "应届生", value: 0}), this.isNoWorkExp && i.push({
      name: "无工作经验",
      value: 0
    }), i.reverse(), i
  ...
  t.prototype = {
    constructor: t, select: function () {
      ...
      var s = e(t).parent().hasClass("dropup"), a = (s || (i.top, i.height), e(t).hasClass("dropdown-menu-right"));
      a || i.left;
      ...
      }), 1 == t.length && i.options.emptyItem && t.eq(0).addClass("empty").find("a").prepend("<span>回车添加标签</span>"), t.length && n.$menu.parent().find(".skills-pannel").hide(), this.autoSelect && !s && (t.filter(":not(.dropdown-header)").first().addClass("active"), this.$element.data("active", t.first().data("value"))), this.$menu.html(t), this
      ...
      if (!(a.options.maxTags && a.itemsArray.length >= a.options.maxTags) && (!1 === t || t)) {
        ...
        if (!t.toString().match(/^\s*$/)) {
          if (a.isSelect && !a.multiple && a.itemsArray.length > 0 && a.remove(a.itemsArray[0]), "string" == typeof t && "INPUT" === this.$element[0].tagName) {
            var o = a.options.delimiterRegex ? a.options.delimiterRegex : a.options.delimiter, r = t.split(o);
            if (r.length > 1) {
  ...
  e.fn.suggestion = function (t) {
    ...
    t.blankHTML && (l += '<div class="suggestion-blank">', l += n(t.blankHTML, {searchText: '<span class="suggestion-text"></span>'}), l += "</div>"), l += "</div>", this.each(function (n, d) {
      ...
      function u(t, i) {
        ...
        }), v.show(), y.length > 0 && y.hide()) : (v.hide(), y.length > 0 && (w.text(i), y.show())), v.html(n)
      }
      ...
      var m = e(t.input || ".suggestion-ipt", f).length > 0 ? e(t.input || ".suggestion-ipt", f) : e(".suggestion-ipt", f),
        ...
        y = e(t.blank, g).length > 0 ? e(t.blank, g) : e(".suggestion-blank", g), w = e(".suggestion-text", y),
        b = s(t.onChecked, f, i), $ = s(t.onHover, f, i), x = s(t.onShow, f, i), C = s(t.onHide, f, i), k = 0, T = !1,
        _ = !0, S = 0, D = -1;
      g.bind("suggestion.show", function () {
        ...
        if (!(g.is(":hidden") || 0 == S || T || 13 != t.keyCode && 38 != t.keyCode && 40 != t.keyCode)) {
          ...
          var n = e(".suggestion", f), s = n.height(), a = n.offset().top, o = i.height(), r = i.offset().top,
      ...
      url: "/wapi/zpCommon/data/city.json", type: "get", dataType: "json", success: function (e) {
        if (0 == e.code) {
          ...
          var t = e.zpData.cityList, i = t.length, s = e.zpData.hotCityList, a = s.length,
            o = {code: 1e8, name: "热门", subLevelModelList: s, firstChar: "a", rank: 0, index: 0};
  ...
  var c = t, l = c.document, d = [], p = {}, u = {}, h = {}, f = null,
    m = '<li data-code="$code$" data-name="$name$">$name$</li>', g = "", v = !1, y = [], w = !1;
  e.fn.citySelector = function (t) {
    ...
    e(this).length && r(function () {
      ...
      i.each(function () {
        function r(e, t) {
          var i = w.height(), n = w.offset().top, s = e.height(), a = e.offset().top, o = t.height(),
        ...
        var v = e(t.input || ".suggestion-ipt", g).length > 0 ? e(t.input || ".suggestion-ipt", g) : e(".suggestion-ipt", g),
          ...
          w = e(".city-selector", g), b = e(".city-selector-province", g), $ = e(".city-selector-citys", g), x = 0,
          C = 0, k = 0, T = !0, _ = !1, S = a(t.onChecked, g, i), D = a(t.onHover, g, i), E = a(t.onShow, g, i),
          j = a(t.onHide, g, i);
        w.bind("selector.show", function () {
          w.is(":hidden") && (w.show(), E())
        }), w.bind("selector.hide", function () {
          w.is(":visible") && (w.hide(), j())
        }), b.html(o), u(), y && m(y), v.is(":focus") && w.trigger("selector.show"), b.on("mouseenter", function (e) {
          k = 0, d()
          ...
          S(e(this)), w.trigger("selector.hide")
        }), e("li", b).on("click", function (t) {
          S(e("li.active", $)), w.trigger("selector.hide")
        }), v.on("focus", function () {
          g.find(".dropdown-select").addClass("dropdown-select-open"), w.trigger("selector.show")
        }), v.on("blur", function () {
          g.find(".dropdown-select").removeClass("dropdown-select-open"), T && w.is(":visible") && w.trigger("selector.hide")
          ...
          T = !0, 0 == e(t.target).closest(v).length && w.trigger("selector.hide")
        }), g.suggestion({
          input: v,
          focusSugges: !1,
  ...
  var t, i = {
    ...
    xul: {
      ...
      get: function (e) {
        ...
        if (void 0 === t) {
          var i = {position: 0, start: 0, end: this.val().length, length: this.val().length, text: this.val()};
  ...
  function r(e, t) {
    for (var r, c, d, p = e.val(), u = e.textrange("get"), h = u.start, f = 0, m = p.split(/[\n\r]/g), g = o(p, u), v = g.startLine, y = g.startLineIndex, w = g.endLineIndex, b = g.lineCount, $ = t ? n(m[v]) : i(m[v]), x = m[Math.max(v - 1, 0)].match(l), C = t ? x && x[4] ? x[4] : "." : "●", k = x && x[3] ? parseInt(x[3]) : 0, T = 0, _ = 0; _ < b; _++) c = _ + v, r = m[c], T = r.length, $ ? r = s(r) : (k++, r = a((t ? k : "") + C, r)), d = r.length - T, c === v ? (h += y + d < 0 ? -1 * y : d, h = Math.max(h, 0), f += 1 == b ? w - y : r.length - Math.max(y + d, 0)) : f += _ == b - 1 ? Math.max(w + d, 1) : r.length, _ > 0 && f++, m[c] = r;
    e.val(m.join("\n")).textrange("set", h, f).focus().trigger("input")
  }

  var c = /^((\s+)?●(\s+)?)/, l = /^((\s+)?(\d+)([\.|、])(\s+)?)/, d = /^((\s+)?(((\d+)([\.|、]))|●))(\s+)?/;
  e.fn.extend({
    textarealist: function (t) {
      var a = e.extend({wrapClass: ".serial-wrap", btnNum: ".serial-btn-num", btnBullet: ".serial-btn-bullet"});
      this.each(function () {
        if (!this.__textareaListInited) {
          this.__textareaListInited = !0;
          var t = e(this), c = t.closest(a.wrapClass).length > 0 ? t.closest(a.wrapClass) : t.parent(),
            l = e(a.btnNum, c);
          e(a.btnBullet, c).on("click", function () {
            r(t, !1)
          }), l.on("click", function () {
            r(t, 1)
          }), t.on("keyup", function (a) {
            if (13 == a.keyCode) {
              var c = t.val(), l = t.textrange("get"), d = c.split(/[\n\r]/g), p = o(c, l),
    ...
    init: function () {
      ...
      n.options.touch && o.on({
        touchstart: function (e) {
          ...
          var t = e.originalEvent.changedTouches[0].clientY, i = e.originalEvent.changedTouches[0].clientX, s = l - t,
            a = d - i;
      ...
      var n = this, s = n.$element, a = n.clickable, o = s.find(".slider-dot i"), r = s.parent().find(".slider-nav a"),
        c = s.children("ul"), l = c.children("li");
      if (!a) return !1;
...
var Storage = {
  ...
  init: function () {
    ...
    $.toast({type: "loading", content: "加载举报类型中..."});
    var e = {parentCode: 0};
    $.post({
      url: "/wapi/zpuser/h5/user/report/getAllReason", data: e, success: function (e) {
        ...
        $.toast({content: e.message || "请求失败", type: "error"})
      }
    })
    ...
    $.get("/wapi/zpuser/wap/report/random", function (s) {
      ...
      })) : 7 == s.code && void 0 !== Detail ? Detail.showSign(1011) : $.toast({content: s.message, type: "error"})
    })
    ...
    el.fileupload({
      ...
      add: function (e, t) {
        ...
        return fileInfo = i, typeRule.test(n) ? s > maxSize ? void $.toast({
          content: "请上传3M以内的文件",
          type: "error"
        }) : Report.uploadCount >= 6 ? void popContent.find(".preview").siblings(".text-error").html("最多可以上传6张照片") : (popContent.find(".preview").siblings(".text-error").html(""), t.formData = {source: "report"}, void t.submit()) : void $.toast({
        ...
        }, 500)) : (uploadContainer.find("a").html("上传图片"), $.toast({
          content: result.resmsg,
          type: "error"
        }), "验证码错误" == result.resmsg && (vertifyEl.val("").focus(), popContent.find(".verify-box img").click()))
      },
      fail: function (e, t) {
        uploadContainer.find("a").html("上传图片"), $.toast({content: "上传失败", type: "error"})
      }
    })
  }, submitForm: function (e, t, i, n) {
    var s = e, a = $.trim(s.find("textarea").val()), o = !1, r = this, c = "", l = "", d = [], p = "";
    if (n.length && (s.find(".active").each(function () {
      d.push($(this).attr("data-code"))
    }), !(d = d.join(",")))) return $.toast({type: "error", content: "请先选择说明标签"}), !1;
    s.find(".ipt-wrap").each(function () {
    ...
    return o && (o = !1, $.ajax({
      ...
      success: function (t) {
        0 === t.code ? ($.toast({
          ...
          content: t.message,
          type: "error"
        }), "验证码错误" == t.message && (s.find(".verify-box .ipt").val("").focus(), s.find(".verify-box img").click()))
      },
      error: function (e) {
      }
    })), !1
    ...
    if (void 0 != e.find(".ipt").attr("data-range")) {
      if (t = e.find(".ipt").attr("data-range").split(",")[1], i.length > t) return e.next(".text-error").html("请输入" + t + "个字以内的内容"), !1;
...
var Block = function () {
      ...
      var n, s = {}, o = function (e, t) {
        ...
        if (s.activityType && s.activityEndDate) {
          ...
          n = new Clocking(i, 1e3), n.interval(function (i) {
            var n = "";
            n = i.day > 0 ? '<span class="prom-text">距结束</span>' + t(i.day) + "&nbsp;天" : '<span class="prom-text">距结束还剩</span>' + t(i.hour) + "：" + t(i.minute) + "：" + t(i.second), e.find(".hot-promotion").html(n)
          })
        }
      }, p = {
        open: function (e) {
    ...
    function n(t, i) {
      var n, s = function (t) {
        ...
        s.next = function () {
          ...
          if (e.$confirmButton.text(o + "：￥" + t.pay), e.$btnc.on("click", ".trial a", function () {
            var t = n.experience;
            t.type = "experience", i.confirm(t), e.close(), __conversion("block_sendjob_purchase_trial")
    ...
    var a = function (e) {
      ...
      return $.isArray(e) ? $.each(e, function (t, i) {
        -1 == i.view ? e[t].view = "无上限" : e[t].view = i.view + "人", -1 == i.employ ? e[t].employ = "无上限" : e[t].employ = i.employ + "人"
      }) : (-1 == e.view ? e.view = "无上限" : e.view = e.view + "人", -1 == e.employ ? e.employ = "无上限" : e.employ = e.employ + "人"), e
    }, p = function (e) {
      var t = $.Deferred();
      ...
      u(t).then(function (n) {
        var s = i, o = a({title: s.title || "发布普通职位个数已达上限", description: s.description}) + l.vip(n.detailPage);
        s.style = "pop-vip", s.cancelText = "我再想想", s.confirmText = "开通VIP帐号", s.next = function () {
          i.confirm({
            ba: n.detailPage.ba,
    ...
    var e = function (e, t) {
      ...
      var n = {
        cancelText: "我再想想", vka: "block_upgradejob_purchase_hot", cancel: function () {
        }, confirm: function () {
    ...
    var e = {}, t = {
      ...
      var t = $(".direct-card-pop .position-category .selected"), i = t.length > 0 ? t.length : 0,
        n = Math.min(i, e.positionDiscount.length - 1), s = e.positionDiscount[n], a = 1e3 * e.positionList[0].price;
      t.each(function (t, i) {
        var t = $(this).index();
      ...
      var e = s(), t = "选择更多职类置顶，提升招聘效果，可享额外折扣";
      if (e.discount > 0) {
        t = "招聘效果提升" + ($(".direct-card-pop .position-category .selected").length + 1) + "倍 额外立减" + 100 * e.discount + "% ", $(".direct-card-pop .position-tip .gray").addClass("discount-tip").text(t)
      ...
      e.save > 0 && (i += "</em><span>(已省" + e.save + ")</span>"), i += "</p>", $(".direct-card-pop .dialog-footer .btns").append(i)
    }, o = function (e) {
      var t = s(), i = function () {
        Payment.success({
          article: "购买成功", text: "即刻置顶职位24小时，邀约匹配牛人投递,可在BOSS直聘APP「我的道具」中查看使用效果", confirm: function () {
            n()
          }
        })
      }, a = {
    ...
    _picCount: 0, _limitPicCount: 3, getContent: function () {
      ...
      $.get("/faqfeedback/pc/create.json").success(function (t) {
        $.dialog({
          ...
          onOpen: function (t) {
            var i = t.find(".upload-pics"), n = t.find(".upload-pic-btn"), s = t.find(".upload-pic-btn-wrapper"),
              a = t.find(".verify-box");
      ...
      elPicsWrap.fileupload({
        ...
        add: function (e, t) {
          ...
          return reg.test(n) ? s > 2e6 ? void $.toast({
            ...
            $.toast({type: "warning", content: "最多上传3张图片"})
          ...
          if ("string" == typeof result && (result = eval("(" + result + ")")), 1 == result.rescode) {
            ...
            type: "error"
          }), "验证码错误" == result.resmsg && (vertifyEl.val("").focus(), popContent.find(".verify-box img").click()), --Feedback._picCount
        },
        fail: function (e, t) {
          clearTimeout(uploadWaringTimer), $.toast({content: "上传失败", type: "error"}), --Feedback._picCount
        }
      })
      ...
      return t && (t = !1, $.ajax({
        ...
        success: function (t) {
          if (t.rescode) {
            $.toast({content: "反馈成功！我们会尽快核实处理", type: "success"});
            try {
        ...
        error: function (e) {
          $.toast({content: "提交失败，请稍后再试", type: "error"});
          try {
            _T.sendEvent("feedback_fail")
          } catch (e) {
          }
      ...
      if (void 0 != e.find(".ipt").attr("data-range")) {
        ...
        if (i = s[0], t = s[1], n.length > t) return e.next(".text-error").html("请输入" + t + "个字以内的内容"), !1;
        if (e.next(".text-error").html(""), n.length < i) return e.next(".text-error").html("内容描述至少" + i + "个字"), !1;
        e.next(".text-error").html("")
      }
      if ("" == n) {
  ...
  COOKIE_DOMAIN = function () {
    ...
    function e(e, i) {
      ...
      if (s && (Cookie.set(GATEWAY_TOKEN_NAME, s, n, COOKIE_DOMAIN, "/"), void 0 !== window.wst && "function" == typeof window.wst.postMessage)) {
        var a = {
          name: "setWKCookie",
          params: {url: COOKIE_DOMAIN, name: GATEWAY_TOKEN_NAME, value: encodeURIComponent(s), expiredate: n, path: "/"}
        };
...
myCookie.getCookie = function (e) {
  ...
  function i() {
    if (g) {
      ...
      $.dialog({title: "", content: g, closeText: !0, cancelText: "", confirmText: "", wrapClass: "home-city-dialog"})
    }
  }
  ...
  function s() {
    ...
    e > 0 ? y.css("bottom", e) : y.css("bottom", 0)
  }
  ...
  var c = {
    init: function (e) {
      ...
      $("#siderbar").append(i), this.tabTemplate(function (t) {
        var i = "";
        i = '<p class="sider-title">' + e.curTab.title + '<a href="javascript:;">查看全部</a></p>                ' + t + " ", $("#siderbar .sider-detail").html(i)
      })
      ...
      return $.each(e, function (e, c) {
        s = "", a = "/job_detail/" + c.encryptJobId + ".html", o = c.salaryDesc, 2 == c.jobValidStatus && (s = "opacity", a = "javascript:;", o = "停止招聘"), c.salaryMonthText && (r = "·" + c.salaryMonthText), 1 == t.curTab.index && (i = '<button class="btn btn-primary btn-small btn-sider-interest"  data-jobid="' + c.encryptJobId + '">移除</button>');
        var l = c.brandStageName ? '<span class="vline"></span><span>' + c.brandStageName + "</span>" : "", d = "";
        1 == c.proxyType ? d = '<img class="job-medium-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon2.png" alt="代招职位">' : 3 == c.proxyType && (d = '<img class="job-medium-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon3.png" alt="派遣职位">'), n += '                         <li class="' + s + '">                            <a href="' + a + '">                                <h4><span class="sider-degree">' + o + r + '</span><span class="sider-position-title"><span class="title-text' + (1 == c.proxyType || 3 == c.proxyType ? "" : " no-medium") + '">' + c.jobName + "</span>" + d + '</span></h4>                                <p class="company-info">                                    <span>' + c.brandName + "</span>" + l + '                                </p>                                <p>                                    <img class="user-avatar" src="' + c.bossAvatar + '" alt=""/>                                    <span class="user-text">' + c.bossName + '<span class="vline"></span>' + c.bossTitle + "</span>                                    " + i + "                                </p>                            </a>                        </li>"
      ...
      for (var s in n) {
        ...
        i = "", $.each(n[s], function (e, t) {
          btnstr = "", 0 == t.statusCode && (btnstr = '                        <span class="btns-sider-interview">                            <a href="javascript:;" class="btn btn-cancel">拒绝</a>                            <a href="javascript:;" class="btn btn-submit">接受</a>                        </span>'), i += '                    <li data-interviewId="' + t.interviewIdStr + '">                        <div class="interview-container">                            <h4 class="sub-title"><span class="interview-status">' + t.statusDesc + '</span><span class="company-name">' + t.brandName + '</span></h4>                            <p class="interview-info">                                时间：<span>' + t.appointmentTime.split(" ")[1] + "</span><br>                                职位：<span>" + t.jobName + "</span><br>                                薪资：<span>" + t.jobSalary + '</span><br>                            </p>                            <p class="interview-user-info">                                <img src="' + t.bossAvatar + '"  alt=""/>                                <span class="user-text">' + t.bossName + '<span class="vline"></span>' + t.bossTitle + "</span>                                " + btnstr + "                            </p>                        </div>                     </li>"
        }), t += '                <div class="oneday-wrap ' + s + '" data-value = "' + s + '">                <p class="interview-time"> ' + n[s][0].appointmentWeekDesc + " <span>" + r + "月" + o + '日</span></p>                <ul class="interview-list">                ' + i + "                </ul>                </div>"
      }
      ...
      $("body").on("click", "#siderbar .siderbar-top li a", function (e) {
        ...
        if ($(t).hasClass("btn-sider-interest")) {
          e.preventDefault();
          var i = $(this);
          $.post("/geek/tag/jobtagupdate.json", {jobId: $(t).attr("data-jobid"), tag: "4", flag: "0"}, function () {
        ...
        var i = $(this), n = i.closest("li").index(), s = i.closest(".oneday-wrap").attr("data-value"), a = t.target;
        return $(a).hasClass("btn-submit") ? c.showInviteTip(function () {
          ...
          e.interviewData[s].splice(n, 1), i.closest("li").find(".interview-status").html("已拒绝").end().slideUp(300, function () {
  ...
  if ($(window).scroll(function () {
    ...
    e.preventDefault(), $.ajax({
      ...
      success: function (e) {
        ...
        } else $.toast({type: "error", content: "服务器异常"})
      },
      error: function () {
  ...
  var m = function () {
    Attachment.showUploadWarningPretreatment({
      ...
      callbackUpload: function () {
        $.toast({type: "success", content: "上传成功"})
      }
    })
  };
      ...
      success: function (e) {
        if (0 == e.code && e.zpData && e.zpData.length > 0) {
          ...
          $.each(e.zpData, function (e, n) {
            var s = window._PAGE || {};
            n.name + "站" === s.citySiteName ? t = n : i += '<li class="city-item"><a ka="city-sites-' + n.code + '" href="' + n.url + '">' + n.name + "站</a></li>"
          });
  ...
  if ($(".manager-list .manager-inner").length && $(".manager-list li").length > 1 && ($(".manager-list h3").css("background", "none"), $(".manager-list .manager-inner").hwSlider({
    ...
    var t = $(this), i = t.find(".info-primary a"), n = i.attr("href"), s = $(".job-tab"), a = s.attr("data-keyword"),
      o = s.attr("data-l3code"), r = s.attr("data-filter"), c = s.attr("data-rescount"), l = s.attr("data-page"),
      d = i.attr("data-index"), p = i.attr("data-lid"), u = i.attr("data-itemid"), h = s.attr("data-lid"),
      f = i.attr("data-jobid");
    ...
    if ("A" == e.target.nodeName && e.target.href.indexOf("job_detail") > -1) {
      var m = e.target.getAttribute("href"), g = e.target.getAttribute("data-lid"), v = e.target.getAttribute("ka"),
        y = $(e.target);
      return y.wrap('<form action="' + m + '" method="get" target="_blank"></form>'), y.append('<input type="hidden" name="ka" value="' + v + '_blank" />'), y.append('<input type="hidden" name="lid" value="' + g + '" />'), y.closest("form").submit(), y.find('input[name="ka"]').remove(), y.find('input[name="lid"]').remove(), y.unwrap("form"), !1
    }
    var w = {keyword: a, l3code: o, filter: r, rescount: c, page: l, index: d, lid: p, itemid: u, source: h, jobid: f};
    "A" == e.target.nodeName && 0 != $(e.target).parents(".company-text").length && (w = {
      keyword: a,
      l3code: o,
      filter: r,
      rescount: c,
    ...
    var v = $("#footer"), y = $(".footer-scan"), w = $(".home-box .job-list"), b = $(window);
    w.css("margin-bottom", "105px"), s(), $(window).scroll(function () {
      s()
    }), y.find(".footer-scan-close").click(function () {
      y.fadeOut(300, function () {
        w.css({"margin-bottom": "15px", transition: "all 0.2s"}), $("#siderbar").css({
          bottom: "214px",
          transition: "all 0.2s"
        })
      })
  ...
  ({
    ...
    initEvent: function () {
      ...
      $(document).on("mouseenter", "#main .guide-app-download-icon", function () {
        var t = $(this), i = $(this)[0].getBoundingClientRect().left, n = $(this)[0].getBoundingClientRect().top;
    ...
    renderCard1: function (e, t, i) {
      var n = "";
      e.cityName && (n = e.cityName), e.areaDistrict && (n = n ? n + "·" + e.areaDistrict : e.areaDistrict), e.businessDistrict && (n = n ? n + "·" + e.businessDistrict : e.businessDistrict);
      var s = "";
      e.jobLabels[1] && (s = e.jobLabels[1]), s && e.jobLabels[2] && (s = s + '<span class="vline"></span>' + e.jobLabels[2]);
      var a = "", o = "";
      1 == e.proxyType && (o = '<img class="job-daizhao-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon2.png" alt="代招职位">'), 3 == e.proxyType && (a = '<img class="job-paiqian-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon3.png" alt="派遣职位">');
      var r = $("#page_key_name").val() || "";
      return $('<li><div class="sub-li"><a href="/job_detail/' + e.encryptJobId + ".html?pk=" + r + "&ka=rcmd_list_job_" + (1 * t + 1) + "_blank&lid=" + e.lid + "&sessionId=" + i + '" ka="rcmd_list_job_' + t + '" class="job-info" target="_blank"><div class="sub-li-top"><p class="name">' + (e.jobName || "") + "</p>" + a + o + '<div class="guide-app-download-icon"></div><p class="salary">' + (e.salaryDesc || "") + '</p></div><p class="job-text">' + s + '</p></a><div class="sub-li-bottom"><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=rcmd_list_company_" + (1 * t + 1) + '" ka="rcmd_list_company_' + t + '"  class="user-info" target="_blank"><p><img src="' + e.brandLogo + '"></p></a><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=rcmd_list_company_" + (1 * t + 1) + '" ka="rcmd_list_company_' + t + '" class="sub-li-bottom-commany-info" target="_blank"><span class="name">' + (e.brandName || "") + '</span></a><div class="sub-li-bottom-commany-place"><i class="job-card-location"></i><span class="name">' + n + "</span></div></div></div></li>").data("data", e)
    },
    renderCard2: function (e, t, i) {
      ...
      1 == e.proxyType && (o = '<img class="job-daizhao-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon2.png" alt="代招职位">'), 3 == e.proxyType && (a = '<img class="job-paiqian-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon3.png" alt="派遣职位">');
      var r = $("#page_key_name").val() || "";
      return $('<li><div class="sub-li"><a href="/job_detail/' + e.encryptJobId + ".html?pk=" + r + "&ka=new_list_job_" + (1 * t + 1) + "_blank&lid=" + e.lid + "&sessionId=" + i + '" ka="new_list_job_' + t + '" class="job-info" target="_blank"><div class="sub-li-top"><p class="name">' + (e.jobName || "") + "</p>" + a + o + '<div class="guide-app-download-icon" src=""></div><p class="salary">' + (e.salaryDesc || "") + '</p></div><p class="job-text">' + s + '</p></a><div class="sub-li-bottom"><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=new_list_company_" + (1 * t + 1) + '" ka="new_list_company_' + t + '" class="user-info" target="_blank"><p><img src="' + e.brandLogo + '"></p></a><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=new_list_company_" + (1 * t + 1) + '" ka="new_list_company_' + t + '" class="sub-li-bottom-commany-info" target="_blank"><span class="name">' + (e.brandName || "") + '</span></a><div class="sub-li-bottom-commany-place"><i class="job-card-location"></i><span class="name">' + n + "</span></div></div></div></li>").data("data", e)
    },
    ...
    getRecommendInfo: function (e) {
      var t = this;
      $.ajax({
        type: "get", url: "/wapi/zpgeek/recommend/conditions.json", dataType: "json", success: function (e) {
    ...
    renderRecommendSelect: function (e) {
      ...
      for (var s = 0; s < e.length; s++) n.append($("<div >" + (e[s].locationName || "") + '<div class="vline"></div>' + (e[s].positionName || "") + '<div class="vline"></div>' + (e[s].salary || "") + "</div>").data("data", e[s]));
    ...
    notData: function (e, t) {
      t && t.length > 0 ? e.find(".not-data,.not-data-text").hide() : (e.find(".not-data")[0] ? e.find(".not-data,.not-data-text").show() : e.append($('<div class="not-data"></div><div class="not-data-text">暂无职位</div>')), this.$recommendBox.hide())
    }
  }).init()
}();
var Search = {
  init: function () {
    ...
    Search.searchBox = $(".search-box"), Search.isLoading = !1, $(".bottom-banner .closeIcon").on("click", function () {
      ...
      return "不限" == $(this).text() ? Search.searchBox.find(".industry-sel").find(".label-text b").text("行业不限") : Search.searchBox.find(".industry-sel").find(".label-text b").text($(this).text()), Search.searchBox.find(".industry-code").val($(this).parent().attr("data-val")), Search.searchBox.find(".industry-box ul .cur").removeClass("cur"), $(this).parent().addClass("cur"), e.preventDefault(), Search.searchBox.toggleClass("show-industry"), !1
    ...
    if (Search.searchBox.find(".ipt-search").keydown(function (e) {
      ...
      switch (e.which) {
        case 38:
          t.removeClass("selected"), -1 == n ? (n = -1, n = t.length - 1) : n--,
            t.eq(n).addClass("selected"), Search.addInput(t.eq(n), !0), Search.scrollVisiable(t.eq(n), "up");
          break;
        case 40:
    ...
    $.ajax({
      ...
      type: "GET",
      data: {sceneStr: e.find("input[name=sceneStr]").val(), filter: decodeURI(e.find("input[name=filter]").val())},
      dataType: "json",
      success: function (t) {
        if (0 == t.code) {
    ...
    t.empty(), t.append('<li data-val=""><a href="javascript:;">不限</a></li>'), $(e).each(function (e, i) {
    ...
    $.ajax({
      type: "GET", url: "/wapi/zpCommon/data/position.json", data: {}, dataType: "json", success: function (t) {
    ...
    i || (e.find(".tree-1").html('<li data-id="0" class="">不限</li>' + r), e.find(".tree-2").html('<li class="blank">选择职类</li>')), n ? e.find(".tree-3").html(l) : i && e.find(".tree-2").html(c)
  }, suggest: function (e) {
    ...
    }), e.unshift({name: "热门城市", subLevelModelList: Search.cityData.hotCityList});
    ...
    $.ajax({type: "GET", url: "/wapi/zpCommon/data/cityGroup.json", dataType: "JSON"}).success(function (t) {
      if (0 == t.code) {
        ...
        i.unshift({name: "热门城市", subLevelModelList: t.zpData.hotCityList});
        ...
        $.dialog({
          ...
          onOpen: function (e) {
            ...
            t.on("click", function () {
              if (e.find(".section-city").scrollTop(0), t.removeClass("active"), $(this).addClass("active"), "热门城市" == i[$(this).index()].name) {
...
var PositionHistory = {
  init: function () {
    ...
    return testHtml = '<ul class="resume-refresh"> <li class="refresh-test"><h4>五维职业性格测评</h4><i class="refresh-test-img"></i><p>专业分析职场优势</p><a class="btn refresh-btn" target="_blank" href="/activity/personality/index.html?ka=rcmd-list-personality">立即测试</a></li></ul>', testHtml
  }
};
$(function () {
...
var Detail = {
  hoverTimer: null, init: function (wrap) {
    ...
    function setPopjobTop(e, t, i) {
      var n = e.find(".info-detail"), s = document.documentElement.clientHeight - t.get(0).getBoundingClientRect().top,
        a = n.height();
    ...
    }), $(".company-detail-guide-download-app-v62")[0] || $(document.body).append('<div class="company-detail-guide-download-app-v62" style="display:none"><div class="app-icon-arrow"></div><div class="app-icon-v62"></div><div class="app-icon-des-v62">下载App  查看更多</div></div>'), $(document).on("mouseenter", "#main .company-name .company-guide-loaddown-app", function () {
    ...
    $(".links-friends a").each(function () {
      ...
      e.toggleClass("show-business-all"), e.hasClass("show-business-all") ? ($(this).find("span").text("收起"), $(this).find(".fz").removeClass("fz-slidedown").addClass("fz-slideup")) : ($(this).find("span").text("展开"), $(this).find(".fz").removeClass("fz-slideup").addClass("fz-slidedown"))
    ...
    if (tagContainer.each(function (e, t) {
      ...
      Attachment.showUploadWarningPretreatment({showCvEntry: !0, title: "", confirmText: "上传附件简历"})
      ...
      "false" != hasMore && ($(this).find(".more").text("加载中..."), $.ajax({
        type: "GET",
        url: "/gongsi/ljobdata.json",
        data: {companyId: companyId, page: nowPage + 1},
        dataType: "json",
        success: function (result) {
          "string" == typeof result && (result = eval("(" + result + ")")), 0 === result.code ? (el.attr("data-page", nowPage + 1), el.find("ul").append(result.zpData.html), result.zpData.hasMore || loadMoreBtn.hide(), loadMoreBtn.find(".more").text("点击加载更多")) : loadMoreBtn.find(".more").text("点击加载更多")
        },
        error: function (e) {
        }
      }))
    ...
    var Banner = $(".job-banner"), smallBanner = $(".smallbanner"), bannerHeight = smallBanner.height(), isSliding = !1;
    ...
    if ($("#jobFilter").length > 0 && $(".job-filter").length > 0 && $("#jobFilter").on("click", function () {
      ...
      $(".job-list .info-primary h3.name").each(function (e) {
        var t = $(this), i = t.closest("[data-jid]").attr("data-jid"), n = t.closest("[data-lid]").attr("data-lid");
        t.hoverDelay({
    ...
    $(".equity-table .equity-expand-btn label").click(function () {
      "展开" == $(this).text() ? ($(this).html('<span>收起</span><i class="fz fz-slideup"></i>'), $(".company-detail-grab .company-equity .equity-detail .equity-table .row-3 ~ tr").css("display", "table-row")) : ($(this).html('<span>展开</span><i class="fz fz-slidedown"></i>'), $(".company-detail-grab .company-equity .equity-detail .equity-table .row-3 ~ tr").css("display", "none"))
    });
    ...
    if ($fakeBanner.length && $(elAnchors).on("click", function (e) {
      if ("公司简介" == this.innerText && (window.location.pathname.indexOf("/gongsi/") > -1 || window.location.pathname.indexOf("/gongsis/") > -1) && (e.preventDefault(), $("html,body").animate({scrollTop: 0})), "工商信息" == this.innerText || "股权信息" == this.innerText || "公司地址" == this.innerText) for (var t = 0; t < elSectionTitles.length; t++) this.innerText == elSectionTitles[t].innerText && $("html,body").animate({scrollTop: $(elSectionTitles[t]).offset().top - bannerRect.height});
      "招聘职位" == this.innerText && $("html,body").animate({scrollTop: $(".job-sec.search-box").offset().top - bannerRect.height});
      ...
      switchExpandVisibility(), $linksContents.addClass("limited"), $el.on("click", ".title-item", function () {
        ...
        $titleItems.removeClass("cur"), $linksContents.removeClass("cur"), e.addClass("cur"), $($linksContents[t]).addClass("cur").removeClass("limited"), switchExpandVisibility(), $linksContents.addClass("limited"), $expandBtn.html('<span>展开</span><i class="fz fz-slidedown"></i>')
      }), $expandBtn.on("click", function () {
        var e = $(".links-wrapper").find(".cur");
        e.toggleClass("limited"), e.hasClass("limited") ? $expandBtn.html('<span>展开</span><i class="fz fz-slidedown"></i>') : $expandBtn.html('<span>收起</span><i class="fz fz-slideup"></i>')
      })
    }
    $(".company-job.company-desc .job-list li").length > 0 && $(".company-job.company-desc .job-list").on("click", "li", function (e) {
      ...
      return !1
    }), Detail.salaryInfoHeightSet()
  }, salaryInfoHeightSet: function () {
    var e = $(".salary-info");
    if (e.length) {
      e.find("h3").height() + e.find(".text").height() + 10 > 170 && e.append('<span class="change-btn"><i class="arrow"></i>查看全部</span>'), $(".salary-info .change-btn").on("click", function () {
        var t = 0;
        e.hasClass("salary-info-open") ? ($(".salary-info .change-btn").html('<i class="arrow"></i>查看全部'), e.removeClass("salary-info-open"), t = 0) : ($(".salary-info .change-btn").html('<i class="arrow"></i>收起全部'), e.addClass("salary-info-open"), t = 1);
        try {
          var i = {action: "action-detail-job-salaryall", p: t};
          Report.myActionLog(i)
        } catch (e) {
        }
      })
    }
    ...
    $.ajax({
      ...
      error: function (e) {
        $.toast({content: "请稍后再试", type: "error"})
      }
    })
  }, deliveResume: function (e, t, i) {
    var n = t || e.attr("data-url");
    e.attr("redirect-url");
    n = n.replace("/gchat/deliveryResume.json", "/wapi/zpgeek/resume/onekeydeliver.json"), e.hasClass("btn-loading") || e.hasClass("btn-disabled") || (e.html('<i class="icon-loading"></i>投递中').addClass("btn-loading"), $.ajax({
      url: n + "&resumeId=" + i, type: "post", dataType: "json", success: function (t) {
        ...
        0 === t.code ? $.dialog({
          ...
          wrapClass: "",
          onOpen: function (t) {
            $(".btn-sendresume").text("已投递").removeClass("btn-loading").addClass("btn-disabled"), $(e).text("已投递").removeClass("btn-loading").addClass("btn-disabled")
          },
          onConfirm: function (e) {
            e.remove()
          }
        }) : n.bizCode ? 1 == n.bizCode ? (Detail.showBlockDialog(n.bizData.chatRemindDialog, e, 2, i), e.text("投递简历").removeClass("btn-loading")) : 2 == n.bizCode ? Detail.showGrabTip(e) : $.dialog({
        ...
        }) : 1011 == t.code || 7 == t.code ? (Detail.showSign(1011), e.text("投递简历").removeClass("btn-loading")) : 1 == t.code ? $.dialog({
          content: t.message,
          title: "",
          type: "warning",
          closeText: !1,
    ...
    "javascript:;" != e.attr("href") || e.hasClass("btn-disabled") || (e.addClass("btn-disabled"), $.ajax({
      type: "POST", url: s, dataType: "JSON", data: null, success: function (t) {
        if (0 == t.code) {
          if ("立即沟通" == e.text() && t.zpData && t.zpData.greeting) var n = $.dialog({
          ...
          e.attr("href", e.attr("redirect-url")).text("继续沟通"), e.removeClass("btn-disabled")
    ...
    var e = e, i = e.attr("data-url"), n = e.attr("data-send-url"), s = e.attr("redirect-url");
    "javascript:;" != e.attr("href") || e.hasClass("btn-disabled") || (e.addClass("btn-disabled"), $.ajax({
      type: "POST",
      url: i,
      dataType: "JSON",
    ...
    e.showNotRemind && (l = "<div class='remindType'><label><input type='checkbox'>不再提醒</label></div>");
    var d = {
      content: "<p>" + o + "</p>" + l,
      title: a,
      closeText: !1,
    ...
    $.ajax({
      ...
      error: function () {
        $.toast({content: "道具使用失败，请稍后再试！", type: "error"})
      }
    })
    ...
    Detail.getIntersetStatus(e).then(function (t) {
      var i = t.zpData.bizData, n = t.zpData, s = "感兴趣";
      3 === n.bizCode && (s = "要, 发简历");
      var a = "";
      a += '<i class="arrow-noumenon"></i>', a += "<p>" + n.bizMessage || t.message + "</p>", a += '<div class="btn-wrap">', a += "</div>";
      var o = $.dialog({
        content: a,
        title: "",
        closeText: !1,
    ...
    e.hasClass("disabled") || (i = "感兴趣" == e.text() ? 1 : 0, e.addClass("disabled"), $.ajax({
      ...
      error: function (t) {
        e.removeClass("disabled"), 603 === t.status || $.toast({content: "网络或服务故障，请稍后再试", type: "error"})
      }
    }))
    ...
    $.ajax({
      type: "POST", url: n, data: null, dataType: "json", success: function (e) {
        0 == e.code ? ($.toast({content: "已接受邀请", type: "success"}), setTimeout(function () {
        ...
        $.toast({content: "网络或服务故障，请稍后再试", type: "error"})
      }
    })
    ...
    e.hasClass("disabled") || (e.addClass("disabled"), $.ajax({
      ...
      error: function () {
        $.toast({content: "网络或服务故障，请稍后再试", type: "error"}), e.removeClass("disabled")
      }
    }))
    ...
    if ("undefined" != typeof _jobInfo) {
      $.get("/wapi/zpitem/web/competitive/jobDetail.json", {encryptJobId: _jobInfo.job_id}, function (n) {
        0 == n.code ? (e.find(".prop-default").removeClass("prop-default"), e.find("h3").append("<span>已开启</span>"), t.find(".level-" + (n.zpData.position + 1)).prepend('<p class="text-position icon-position">您的位置</p>'), i.find(".pull-right").siblings().html("个人综合排名：<span>三个月内共<em>" + n.zpData.totalNum + "</em>位牛人沟通</span>"), i.find(".pull-right").html('<a href="javascript:;" class="link-detail" ka="check_personal_competitive_detail">查看完整个人竞争力</a>')) : (e.find(".prop-default").removeClass("prop-default"), t.prepend('<p class="text-position">你在？位置</p>'), i.find(".pull-right").html('<a href="javascript:;" class="link-detail" ka="check_personal_competitive_detail">查看完整个人竞争力</a>'))
      });
      var n = function () {
        var e = $.Deferred();
        ...
        n().then(function (e) {
          if (7 == e.code) return void $.toast({content: "竞争力分析器仅在已登录状态下可使用 ", type: "error"});
          if (24 == e.code) $.toast({
...
var Deliver = {
  init: function () {
    ...
    e && (Deliver.para.page = 0, Deliver.listCon.html(""), Deliver.listWrap.find(".user-list").hide(), Deliver.listWrap.find(".detail-box").hide()), Deliver.para.page++, Deliver.isLoading = !0, Deliver.para.page > 1 && (Deliver.listMoreEl.addClass("disabled"), Deliver.listMoreEl.text("正在加载中...")), $.ajax({
      type: "GET",
      ...
      success: function (t) {
        var t = t, i = "";
        1 == t.rescode && (1 == t.hasMore ? Deliver.listMoreEl.removeClass("disabled").text("加载更多").show() : Deliver.para.page > 1 && Deliver.listMoreEl.addClass("disabled").text("没有更多了").show(), "" == t.html ? e && Deliver.tipsContainer.html('<div class="data-blank"><i class="tip-nodata"></i><b>没有相关数据</b></div>').show() : (i += t.html, Deliver.listCon.append(i), Deliver.tipsContainer.html("").hide()), e && Deliver.listCon.find("li").length < 10 && Deliver.listMoreEl.text("没有更多了").addClass("disabled").hide()), Deliver.isLoading = !1
      },
      error: function (t) {
        Deliver.para.page > 1 && Deliver.listMoreEl.removeClass("disabled").text("数据加载出错").show(), Deliver.isLoading = !1, e && (Deliver.listMoreEl.hide(), Deliver.tipsContainer.html('<div class="data-blank"><i class="tip-errordata"></i><b>数据加载出错</b></div>').show())
      }
    })
  }
};
...
var Validate = {
  init: function (e, t, i) {
    ...
    n.on("submit", function (e) {
      ...
      if (s.each(function () {
        ...
        if (n.attr("action").indexOf("/geek/user/save.json") > -1 && n.find("input[name=name]").length && !n.find("input[name=name]").hasClass("disabled")) {
          ...
          if (Auxiliary.getByteLength(o) < 4) return $.toast({type: "error", content: "姓名应为2-12个汉字或4-24个字母"}), !1
        }
    ...
    if ("locationName" == e.attr("name") && "" != a && "" == e.parent().find('input[name="location"]').val()) return Validate.showError(e, "请输入正确的城市"), !1;
    if (t && "gender" == e.attr("name") && Number(a) < 0) return Validate.showError(e, e.attr("data-blank")), !1;
    if (n) {
      if (n = n.split(","), i && i.length && i.html("<em" + (s > n[1] ? ' class="red"' : "") + ">" + s + "</em>/" + n[1]), s > n[1] || s < n[0]) return Validate.showError(e, "请输入 " + n[0] + "-" + n[1] + " 个字"), !1;
      Validate.hideError(e)
    }
    return !0
...
var FormsUI = {
  eq: 0, appointedBlueCollarPosition: [], init: function (e) {
    ...
    if (this.dropSelect(t), this.prettyRadio(t), this.formEl = t, t.find(".ipt-datetimepicker").length) {
      ...
      nowYear = i.getFullYear(), nowMonth = i.getMonth() + 1, nowThisDate = i.getDate(), t.find(".ipt-datetimepicker").each(function (e) {
        ...
        (o && "y-m-d" == o || "y-m" == o) && (c = 4), "yyyy-mm" == n && (l = 3), t.datetimepicker({
          ...
          if (a) {
            if (new Date(e.date) < new Date(i.val())) return alert("结束时间不能小于开始时间"), !1
    ...
    t.find(".ipt-workyear").length && t.find(".ipt-workyear").workstartpicker(), t.find(".start-salary").on("click", "li", function () {
      ...
      if ($(this).hasClass("selected")) $(this).removeClass("selected"), e.find(".select-industry .industry-title h3").removeClass("red"), e.find(".select-industry .industry-title p.gray").removeClass("red").text("最多可选 3 个技能标签"); else {
        if (e.find(".select-industry .industry-cells .selected").length > 2) return e.find(".select-industry .industry-title h3").addClass("red"), void e.find(".select-industry .industry-title p.gray").addClass("red").text("最多可选 3 个技能标签");
      ...
      if ("确定" == $(this).text()) {
        ...
        }), s.length || (s.push("不限"), a.push("0")), t.find(".select-industry").closest("dd").find(".dropdown-select .ipt").val(s.join("·")), t.find(".select-industry").closest("dd").find('.dropdown-select input[type="hidden"]').val(a.join("·")), t.find(".select-industry").closest("dd").find(".dropdown-select").removeClass("dropdown-select-open"), t.find(".select-industry").closest("dd").find(".dropdown-menu").removeClass("dropdown-menu-open")
      } else if ("取消" == $(this).text()) t.find(".select-industry").closest("dd").find(".dropdown-select").removeClass("dropdown-select-open"), t.find(".select-industry").closest("dd").find(".dropdown-menu").removeClass("dropdown-menu-open"); else if ($(this).hasClass("btn-addtag")) {
        var o = Validate.getLength(i.val()), r = t.find(".select-industry .industry-title p.gray");
        if ("" == i.val().replace(/(\s*$)/g, "")) return r.text("请输入标签名称").addClass("red"), void i.val("");
        ...
        if (t.find(".select-industry .industry-cells span").each(function () {
          ...
          n = !1
        }), n) r.addClass("red").text("该标签已存在"); else {
    ...
    if (t.length) {
      var n = [], s = t.val().split("·"), a = i.val().split("·");
      $.each(a, function (e, t) {
    ...
    function n(n, s, a) {
      if (s.hasClass("ipt-range") && "start" == s.attr("data-range")) {
        var o, r = s.closest(".form-row"), c = s.closest("dd").find(".dropdown-menu ul"),
          ...
          u = e.find('input[name="degree"]').val(), h = parseInt(n.attr("data-val"), 10) || parseInt(n.val(), 10),
          f = t(u), m = h + f, g = "", v = ((new Date).getFullYear(), h + i(u));
        if (!h) return;
        if (!u) return $.toast({type: "error", content: "请先选择学历"}), !1;
        if (1989 == h) g = '<li data-val="1989" ka="edu-end-' + o + '">1990年以前</li>'; else for (var o = m; o > h; o--) g += '<li data-val="' + o + '" ka="edu-end-' + o + '">' + o + "</li>";
    ...
    function s(e, t) {
      ...
      }), FormsUI.appointedBlueCollarPosition.indexOf(t) >= 0 ? (e.closest(".form-work").find("textarea[name=responsibility]").removeAttr("data-range").closest("dd").find(".tip-text").remove(), e.closest(".form-resume").find("textarea[name=responsibility]").removeClass("required").removeAttr("data-range").closest("dd").find(".tip-text").remove().end().closest("dl").find("dt").html("工作内容（选填）")) : (e.closest(".form-work").find("textarea[name=responsibility]").attr("data-range", "5,1600"), e.closest(".form-resume").find("textarea[name=responsibility]").addClass("required").attr("data-range", "5,1600").closest("dl").find("dt").html("工作内容"))
    }

    var e = e || $(document);
    if (e) {
      var a = e.find('input[placeholder="选择职位类型"], input[placeholder="您的职位"]').next('input[name="position"]'),
        o = a ? a.val() : "";
      if (o && s(a, o), 0 === FormsUI.eq) {
        ...
        $(document).on("click", 'input[placeholder="选择期望职位"]', function () {
          ...
          r.init({
            data: t ? "/wapi/zpCommon/data/intern.json" : jobData, onlyTwoLevel: t, callback: function (t) {
          ...
          r.init({
            data: jobData, callback: function (t) {
              e.val(t[2].name), e.next().val(t[2].code), e.next().attr("level2", t[1].code), e.next().attr("level3", t[2].code), $('input[placeholder="选择技能标签"]').val(""), $('input[placeholder="选择技能标签"]').next().val(""), $(".select-tags .industry-cells").html(""), Resume.getSkillsData({
                p1: t[2].code,
                p2: t[1].code
              }, !0), e.closest("dd").find(".tip-text").hide(), "选择职位类型" == e.attr("placeholder") && e.closest(".form-row").find('input[name="positionName"]').val(t[2].name), "guide" == e.data("type") && Guide.showSugSkillTag(t[2].code), s(e, t[2].code)
            }, hasSearch: !0
          })
        }), FormsUI.eq = 1
      }
    ...
    i || (e.find(".tree-1").html(r), e.find(".tree-2").html('<li class="blank">选择职类</li>')), n ? e.find(".tree-3").html(l) : i && e.find(".tree-2").html(c)
  }, setMinSlary: function () {
    var e = Salary.min(), t = '<li data-val="面议">面议</li>';
    $.each(e, function (e, i) {
    ...
    if (e) {
      var i = $(".end-salary"), n = i.find(".ipt"), s = i.find('input[type="hidden"]'), a = i.find("ul"), e = e, o = 0;
      if (e && (n.closest(".dropdown-select").removeClass("dropdown-disabled").parent().parent().find(".range-devide").show(), n.removeAttr("disabled")), "面议" == e) n.val("面议").parent().hide().parent().parent().find(".range-devide").hide(), s.val("面议"); else {
...
var ResumeEditor = {
  ...
  ownerTags: [], skillsData: [], formStatus: !1, parserId: "", init: function () {
    ...
    Resume.isShowResumeAnalyzeTools(!0), $(document).on("click", ".paddingTop60 .go-detail", function () {
      $.ajax({
        url: "/wapi/zpgeek/resume/parser/querybar.json", type: "get", dataType: "json", success: function (e) {
      ...
      $.ajax({
        url: "/wapi/zpgeek/resume/parser/closebar.json", type: "post", dataType: "json", success: function (e) {
    ...
    $.ajax({
      url: "/autocomplete/industry.json", data: {comId: e}, type: "get", dataType: "json", success: function (e) {
    ...
    e.length && (e.removeAttr("readonly"), "" != e.val() && (t = e.val().split("·"), e.val(t.join(",")), Resume.owerSkillData = t), e.tagsinput({
      ...
      if (Resume.getLength(s) > 6 && (n = !0), Resume.tagsPannel.find("li").each(function () {
        ...
        return Resume.skillsContainer.find("input").last().val($(this).val().split(",").join("·")), Validate.hideError(e), void (Resume.skillsContainer.find(".dropdown-select .tag").length > 2 && Resume.skillsContainer.find(".bootstrap-tagsinput input").attr("placeholder", "").css("width", "60px"))
      }
      Resume.skillsContainer.find(".bootstrap-tagsinput input").css("width", "130px")
    }), e.on("itemRemoved", function (e) {
      Resume.skillsContainer.find(".result-selecter").hide(), Resume.skillsContainer.find("input").last().val($(this).val().split(",").join("·")), Resume.skillsContainer.find(".dropdown-select .tag").length || Resume.skillsContainer.find(".bootstrap-tagsinput input").attr("placeholder", "选择或输入技能标签").css("width", "130px"), setTimeout(function () {
    ...
    o && $.ajax({
      ...
      success: function (e) {
        var i, e = e.zpData, o = "", r = n.closest("dd").find(".ipt").val().split("·"), c = [];
        if (e.length > 0) {
      ...
      type: "POST", url: url, dataType: "JSON", data: subData, success: function (result) {
        ...
        if ("string" == typeof result && (result = eval("(" + result + ")")), result.forceFace && (alert("您的账号当前处于不可使用状态，请登录BOSS直聘手机APP查看详情"), window.location.href = "/logout/"), 1 == result.rescode) {
          if (primaryWrap.removeClass("resume-item-open"), str = result.html, resultId = $(str).attr("id"), "resume-userinfo" == primaryModule) if (primaryCon.find(".userinfo-con").html(str), result.isAudit) $.dialog({
            ...
            "0" == formEl.find('input[name="startWorkYearCode"]').val() ? ($resumeHistory.find("h3.title").html("实习经历").next().attr("data-role", "practice"), $resumeHistory.find(".link-add").html('<i class="iboss-tianjia"></i><span>添加</span>'), $resumeHistory.find(".link-delete").show()) : ($resumeHistory.find("h3.title").html("工作经历").next().attr("data-role", ""), $resumeHistory.find(".link-add").html('<i class="iboss-tianjia"></i><span>添加</span>'), $resumeHistory.find(".history-project li").length < 2 && $resumeHistory.find(".link-delete").hide())
          }
    ...
    return "至今" == e[1] ? e[1] = 9999 : "1990以前" == e[1] && (e[1] = 1e3), "1990以前" == e[0] && (e[0] = 1e3), e
    ...
    function l(e, t) {
      ...
      p("/geek/item/resumerefresh/activeness.json", "get", {}).then(function (a) {
        if (n.resData = a, a.data.resumeActiveness) {
          if (resumeActiveness = a.data.resumeActiveness, list = resumeActiveness.recentActiveness, 0 == resumeActiveness.refreshed) var o = '<a class="btn refresh-btn" href="javascript:;">刷新简历</a>'; else if (resumeActiveness.refreshDays > 1) var o = '<a class="btn refresh-bt-grey" href="javascript:;">已连续刷新' + resumeActiveness.refreshDays + " 天</a>"; else var o = '<a class="btn refresh-bt-grey" href="javascript:;">今日已刷新</a>';
          var r = 0 == resumeActiveness.free ? "剩余次数" : "剩余免费次数", l = 0;
          1 == resumeActiveness.free && 2 == resumeActiveness.leftCount && (l = 1);
          var p = '<div class="resume-refresh-hwslider"></a><ul>' + s(a) + '</ul> <a href="javascript:;"  class="arrow-prev"></a><a href="javascript:;"  class="arrow-next"></a></div>' + o + '<p class="refresh-text"><span class="refresh-free-count"><span>' + resumeActiveness.leftCount + "</span>次</span><span>" + r + "</span></p></li>" + i();
          t(l, p), 1 == e && c();
    ...
    function d() {
      var e = this, t = $(".resume-refresh-hwslider"), i = $(".resume-refresh-hwslider .arrow-prev"),
        n = $(".resume-refresh-hwslider .arrow-next"), s = t.children("ul"), a = s.children("li"), o = a.length, r = 10,
        c = !0, l = function (e, i) {
          if (!c) return !1;
          c = !1;
          var n = t.width();
    ...
    function h(e) {
      var t = "立即完善", i = "稍后完善";
      4 == e.rescode ? (t = "我知道啦", i = !1) : 3 == e.rescode && (t = "取消隐藏", i = "稍后处理"), $.dialog({
        title: "暂时无法刷新简历",
    ...
    $.ajax({
      url: "/wapi/zpgeek/resume/quality/query.json", type: "get", dataType: "json", success: function (e) {
        0 == e.code && (-1 == e.zpData.quality && (3001 == e.zpData.resumeDetailStatus ? $(".resume").append("<div class='resume-warning'><p>当前简历信息不完善,影响聊天回复率,修改后你将获得更多的求职机会</p><a href='javascript:;'>简历没问题</a></div>") : $(".resume").append("<div class='resume-warning'><p>当前简历信息不完善，已为你用 <img src='" + staticPath + "/web/geek/images/icon-bad-resume-pre.png'> 标示出需要修改的模块</p><a href='javascript:;'>简历没问题</a></div>"), $(".resume-warning").css("display", "flex")), $(".resume-warning a").click(function () {
          $.dialog({
  ...
  init: function (e) {
    ...
    t.find("#fileupload-trigger").on("click", function () {
      ...
      1 == Attachment.worksList.resumeCount && Attachment.worksList.addResumeTip ? Attachment.showVersionDialog({
        confirmText: "上传作品集附件",
        isWorks: !0
      }) : Attachment.showUploadWarning({confirmText: "上传作品集附件", isWorks: !0})
    });
    var i = null;
    ...
    $.ajax({
      url: "/geek/resume/sidebar.json", type: "get", success: function (e) {
        1 == e.rescode ? (t.html(e.html), Attachment.initEvents(t)) : t.html('<p class="gray">数据加载出错</p>'), Resume.resumeFresh("resume")
      }, error: function () {
    ...
    $.ajax({
      type: "GET", url: "/geek/infodata.json", data: null, dataType: "json", success: function (t) {
        1 == t.rescode ? (e.html(t.html), Attachment.initMember(e), Attachment.initEvents(e)) : e.html('<p class="gray">数据加载出错</p>'), Resume.resumeFresh("user")
      }, error: function () {
    ...
    $.ajax({
      type: "GET", url: "/wapi/zpgeek/resume/attachment/checkbox.json", dataType: "json", success: function (t) {
    ...
    $.dialog({
      content: '<dl class="resume-wrap"><dd class="sec-upload"><div class="upload-wrap"><p class="upload-guide">拖拽文件到这里</p><p class="upload-tip">支持DOC、DOCX、PDF、JPG、PNG格式附件</p></div><a href="javascript:;" ka="resume_attach_upload" class="btn btn-primary btn-file">上传附件简历 <input type="file" name="file" ka="user-resume-upload-file" accept="image/jpg, image/jpeg, image/png, application/vnd.ms-powerpoint, application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document, application/vnd.openxmlformats-officedocument.presentationml.presentation"></a></dd><dd class="sec-make"><div class="zhipin-resume-img"></div><a href="https://cv.zhipin.com/resume/html/my-resumes" target="_blank" ka="resume_attach_create" class="btn btn-primary">在线快速制作</a></dd></dl>',
      title: "",
      closeText: !0,
      confirmText: "",
      cancelText: "",
    ...
    var t = {title: "", confirmText: "上传附件简历", cancelText: "", callbackChat: null, callbackUpload: null},
      e = $.extend(t, e), i = "", n = "upload-dialog-box", s = "dialog_cancel", a = "";
    e.cancelText && ("先聊聊" == e.cancelText && (s = "dialog_upload_deliver_chat"), i = '<button type="button" class="btn btn-outline" ka="' + s + '">' + e.cancelText + "</button>", n = "upload-dialog-deliver"), e.isComplete || (a = '<p>没有附件简历&nbsp;<a href="/web/geek/guide" ka="nlp_no_resume">&nbsp;在线填写</a></p>'), $.dialog({
      content: '<div class="' + n + '"><p>支持DOC、DOCX、PDF、JPG、PNG格式附件</p><p class="red">文件大小不超过8M</p><div class="btns">' + i + '<a href="javascript:;" class="btn btn-file">' + e.confirmText + '<input id="fileupload" type="file" name="file" ka="user-resume-upload-file" title="" accept="' + Attachment.getResumeAccept() + '"></a></div>' + a + "</div>",
      title: e.title,
      closeText: !0,
      confirmText: "",
      cancelText: "",
    ...
    switch (e) {
      case"added":
        n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray"><i class="icon-loading-chrysanthemum"></i>正在上传中</p></div></div>', s = '<h3 class="title">附件状态</h3>' + (t.name ? "<p>附件名称：" + t.name + "</p>" : "") + '<p class="gray">附件内容只能预览10页，且有一定压缩，但不影响Boss看到内容的质量</p>';
        break;
      case"success":
        n = '<div class="img-box"><img src="/wapi/zpgeek/resume/preview4geek/' + t.previewUrl + '"/></div>', s = '<h3 class="title">附件确认</h3>' + (t.name ? "<p>附件名称：" + t.name + "</p>" : "") + (t.size ? "<p>附件大小：" + parseInt(t.size / 1024) + " KB</p>" : "") + (i ? "<p>附件格式：" + i + "</p>" : "") + '<p class="gray">附件内容只能预览10页，且有一定压缩，但不影响Boss看到内容的质量。</p><p class="gray">Boss将你转发给同事时，可能会将附件简历一并转发。</p><div class="btns"><a href="javascript:;" class="btn btn-file btn-outline">重新选择<input id="fileupload" type="file" name="file" ka="user_resume_add_reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a><button type="button" class="btn btn-sure" ka="user_resume_add_sure">确定添加</button></div>';
        break;
      case"preview":
        n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray">预览失败</p><p class="gray">点击 <a href="javascript:;" class="link-refresh text-blue" ka="user-resume-refresh">刷新</a> 重新预览</p></div></div>', s = '<h3 class="title">附件状态</h3><p>附件将在投递后被Boss预览查看，请确认显示正确（预览只展示前10页）</p>' + (t.name ? '<p class="gray">附件名称：' + t.name + "</p>" : "") + '<div class="btns"><a href="javascript:;" class="btn btn-through btn-file">重新选择<input id="fileupload" type="file" name="file" ka="user-resume-upload-fail-reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a></div><p class="gray">支持doc，docx，pdf，jpg，png格式附件，文件大小不超过8M</p>';
        break;
      case"fail":
        n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray">上传失败</p><p class="gray">请重新上传，如仍然无法成功，可尝试更改文件格式</p></div></div>', s = '<h3 class="title">附件状态</h3><p>附件将在投递后被Boss预览查看，请确认显示正确（预览只展示前10页）</p>' + (t.name ? '<p class="gray">附件名称：' + t.name + "</p>" : "") + '<div class="btns"><a href="javascript:;" class="btn btn-through btn-file">重新选择<input id="fileupload" type="file" name="file" ka="user-resume-upload-fail-reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a></div><p class="gray">支持doc，docx，pdf，jpg，png格式附件，文件大小不超过8M</p>'
    }
    return '<div class="pop-resume-box"><div class="resume-wrap"><h3 class="title">上传附件</h3>' + n + '</div><div class="resume-sider">' + s + "</div></div>"
    ...
    e.hasClass("disabled") || (e && e.addClass("disabled"), $.ajax({
      ...
      success: function (t) {
        ...
        } else 0 == t.code && "最多上传三份简历" == t.message ? $.toast({
          type: "error",
          content: t.message
        }) : 0 == t.code && "正在保存，稍等片刻" == t.message ? $.toast({
          type: "error",
          content: t.message
        }) : $.toast({type: "error", content: "保存失败"});
        e && e.removeClass("disabled")
      },
      error: function () {
        $.toast({type: "error", content: "保存失败，请稍后再试"}), e && e.removeClass("disabled")
      }
    }))
    ...
    t > 1 && (n = "确认删除该附件简历吗？已发送给Boss的附件简历不受删除影响。"), $.dialog({
    ...
    var i = e.closest("li").find(".basis").text(), n = i.replace(/\s/g, "").split("."), s = n.splice(0, n.length - 1),
    ...
    $.dialog({
      ...
      onConfirm: function (t) {
        ...
        if (s.length) {
          s.length > 30 ? $.toast({content: "字数不能超过30", type: "warning"}) : ($.ajax({
            type: "POST",
            ...
            error: function () {
              $.toast({content: "重命名失败，请稍后再试", type: "error"})
            }
          }), t.remove());
          try {
...
var Guide = {
  init: function () {
    ...
    $(".base-info").hasClass("hide") ? (t.addClass("hide"), i.addClass("hide")) : (t.removeClass("hide"), i.removeClass("hide")), Guide.$skipExpInfoEl = $(".experience-info .hide"), Guide.$workSkillTipsEl = $(".experience-info .work-skill-tips"), Guide.$freshGraduateEl = $(".base-info .row-fresh-graduate input[name=freshGraduate]"), Guide.$rowSalaryEl = $(".position-info .row-salary"), Guide.$rowRowExpectPositionEl = $(".position-info .row-expect-position"), Guide.$positionInfoFreshGraduateEl = $(".position-info input[name=freshGraduate]"), Guide.$positionNameEl = $(".position-info input[name=positionName]"), Guide.$positionEl = $(".position-info input[name=position]"), Guide.$expectedJobIdEl = $(".position-info input[name=expectedJobId]"), $(".guide .skip").on("click", function () {
      ...
      var e = $(".guide .row-apply-status"), t = $(".guide .row-fresh-graduate"), i = $(".guide .work-or-practice");
      0 == $(this).data("val") ? (Guide.$rowSalaryEl.show(), Guide.$rowSalaryEl.find(".required").prop("disabled", !1), Guide.$rowRowExpectPositionEl.show(), Guide.$rowRowExpectPositionEl.find(".required").prop("disabled", !1), Guide.$positionInfoFreshGraduateEl.val(0), Guide.$positionNameEl.val(""), Guide.$positionEl.val(""), Guide.$expectedJobIdEl.val(normalExpectId || ""), isGeekIntern = !1, e.hide(), t.show().find("input[name=freshGraduate]").prop("disabled", !1), i.text("实习")) : $(this).hasClass("month") && (Guide.$rowSalaryEl.show(), Guide.$rowSalaryEl.find(".required").prop("disabled", !1), Guide.$rowRowExpectPositionEl.show(), Guide.$rowRowExpectPositionEl.find(".required").prop("disabled", !1), Guide.$positionInfoFreshGraduateEl.val(0), Guide.$positionNameEl.val(""), Guide.$positionEl.val(""), Guide.$expectedJobIdEl.val(normalExpectId || ""), isGeekIntern = !1, e.show(), t.hide().find("label").removeClass("radio-checked").end().find("input[name=freshGraduate]").val("").prop("disabled", !0), i.text("工作"))
    ...
    $.dialog({
      ...
      onConfirm: function (e) {
        $(window).off("beforeunload"), $.toast({type: "loading", content: "切换中"}), $.ajax({
          type: "POST",
          ...
          success: function (e) {
            ...
            }, 500)) : $.toast({type: "error", content: "切换失败"}) : $.toast({type: "error", content: e.resmsg})
          },
          error: function () {
            $("#toast").remove(), $.toast({type: "error", content: "切换失败"})
          }
        });
        try {
    ...
    $.dialog({
      ...
      onOpen: function (e) {
        e.find(".dialog-footer .btn-sure").html('选择文件<input id="fileupload" type="file" name="file" accept="application/msword, application/pdf, application/vnd.openxmlformats-officedocument.wordprocessingml.document">'), e.find(".dialog-container").append('<div class="over-layer"></div>'), AnalysisResume.initUploadResume(function (e) {
    ...
    var formEl = form, formWrap = formEl.parents(".info-box"), url = formEl.data("url"),
      ...
      ka = "complete-" + formEl.find('button[type="submit"]').attr("ka"), subData = formEl.serialize();
    btnEl.addClass("btn-disabled").text("请稍后").css("pointer-events", "none"), $("input[name=birthday]").length && $("input[name=birthday]").is(":disabled") && (subData += "&birthday=" + $("input[name=birthday]").val()), $.ajax({
      type: "POST",
      url: url,
      dataType: "JSON",
      data: subData,
      success: function (result) {
        "string" == typeof result && (result = eval("(" + result + ")")), result.forceFace && (alert("您的账号当前处于不可使用状态，请登录BOSS直聘手机APP查看详情"), window.location.href = "/logout/"), 1 == result.rescode ? (Guide.__conversion(ka), result.toUrl ? Guide.processSuccess(result.toUrl) : Guide.showNextForms(formWrap), result.encryptId && (formEl.find('input[name ="id"]').length ? formEl.find('input[name ="id"]').val(result.encryptId) : formEl.find('input[name ="expectedJobId"]').val(result.encryptId))) : Resume.showError(result.resmsg), btnEl.removeClass("btn-disabled").text(oldText).css("pointer-events", "auto")
      },
      error: function () {
        Resume.showError(), btnEl.removeClass("btn-disabled").text(oldText).css("pointer-events", "auto")
      }
...
var UserCheck = {
  checkPhone: function (e, t, i, n, s, a) {
    ...
    var o = "";
    o += '<div class="sign-form check-phone"><form action="' + e + '" method="post">', o += '<div class="form-row"><span class="cell-title">当前登录账号</span><span>' + s + "</span></div>", o += i ? '<input name="phone" value="' + i + '" type="hidden"/>' : "", o += n ? '<input name="regionCode" value="' + n + '" type="hidden"/>' : "", o += '<div class="form-row">', o += '<span class="cell-title" style="vertical-align: top;line-height: 40px;">滑动完成验证</span><div class="row-code ipt-wrap" style="width: 324px; height: 42px;"></div>', o += '<div class="verifyimg-error red"></div>', o += "</div>", o += '<div class="form-row row-sms">', o += '<span class="cell-title">短信验证码</span>', o += '<span class="ipt-wrap">', o += '<i class="icon-sign-sms"></i><input type="text" class="ipt ipt-sms required" placeholder="短信验证码" name="phoneCode" maxlength="6" autocomplete="off"/>', o += '<input type="hidden" name="smsType" value="1" /><button type="button" class="btn btn-sms" data-url="' + t + '">获取验证码</button>', o += '</span><div class="phonecode-error red"></div></div>', o += '<div class="form-footer">', o += '<div class="btns"><button class="btn btn-outline btn-cancel" type="button">取消</button><button class="btn btn-sure" type="submit">确定</button></div>', o += "</div>", o += '<input type="hidden" name="randomKey" class="randomkey" value=""/>', o += a && a.isWxLogin ? '<input type="hidden" name="isWxLogin" value="true"/>' : "", o += "</form></div>", $.dialog({
      content: o,
      title: "请验证手机号",
      cancelButton: "取消",
      confirmButton: "确认",
    ...
    if (!i.length || "" == i.val()) return UserCheck.showError(e, $(".verifyimg-error"), "请滑动完成验证", !0), i.focus(), !1;
    if ($(".verifyimg-error").text(""), !t) {
      if ("" == n.val()) return UserCheck.showError(e, $(".phonecode-error"), "请填写短信验证码", !0), n.focus(), !1;
      if (!n.val().match(/^.{4,6}$/)) return UserCheck.showError(e, $(".phonecode-error"), "请填写正确的短信验证码", !0), n.focus(), !1;
      if (n.val().match(/\D+/)) return UserCheck.showError(e, $(".phonecode-error"), "请填写正确的短信验证码", !0), n.val(""), n.focus(), !1;
      $(".phonecode-error").text("")
    }
    return !0
  }, submitForm: function (e, t, i) {
    var n = e.find(".btn-sms"), s = e.find(".btn-sure"), a = t ? n.data("url") : e.attr("action");
    t || s.html("提交中...").addClass("btn-disabled"), $.ajax({
      url: a, type: "post", dataType: "json", data: e.serialize(), success: function (a) {
        ...
        var o = e.attr("action");
        if (1 != a.rescode && VerrifyCode.reset(e.find(".row-code")), t) if (2 == a.type) if (n.html('已发送(<em class="num">60s</em>)').addClass("count-down btn-disabled"), UserCheck.countDown(n, function () {
          ...
          type: "error",
          content: a.resmsg
        }), n.html("发送验证码").removeClass("count-down btn-disabled"); else if (setTimeout(function () {
    ...
    if (t.text(i), VerrifyCode.reset(e.find(".row-code")), i.indexOf("短信验证码") >= 0 && e.find(".ipt-sms").focus().val(""), n) try {
...
seriesLoadScripts("https://static.zhipin.com/library/js/sdk/verify-sdk.js", function () {
  if (Sign.VerrifySuccessCallback = function (e) {
  ...
  }, !$(".top-sign-box").length && !$(".search-job-list-wrap").find(".sign-quick").length && !$(".job-box .sign-wrap-v2").find(".sign-quick").length && $(".sign-form:visible").find(".row-code").length) {
    new VerifyCodeSDK({
...
var Sign = {
  ...
  init: function (e) {
    ...
    if (Sign.source = getQueryString("s"), Sign.source && (Sign.directUrls = {
      ...
      0 === e ? (i.filter(".geek-slide").removeClass("hide"), i.filter(".boss-slide").addClass("hide")) : 1 === e && (i.filter(".geek-slide").addClass("hide"), i.filter(".boss-slide").removeClass("hide")), $(this).addClass("cur").siblings().removeClass("cur"), new VerifyCodeSDK({
  ...
  showPannel: function (e, t) {
    ...
    var s = "verrify" + Math.random().toString(32).substr(-10, 6), a = e.find(".sign-form:visible").find(".row-code");
    a.attr("id", s), a.length && new VerifyCodeSDK({
      dom: a[0], success: function (e) {
        Sign.VerrifySuccessCallback(e)
      }, ready: function (e) {
        Sign.VerrifyReadyCallback(e)
      }
  ...
  checkForm: function (e, t) {
    var e = e, i = e.find(".ipt-phone"), n = e.find('input[name="regionCode"]'), s = e.find(".ipt-pwd"),
      a = e.find(".ipt-sms"), o = e.find("input[name=policy]"), r = (e.find("input[name=policy]"), e.find(".row-code")),
      c = "";
    if (1 == VERRIFYCODETYPE ? c = e.find("input[name=challenge]") : 2 == VERRIFYCODETYPE && (c = e.find("input[name=csessionId]")), i.length) {
      if ("" == i.val()) {
        Sign.showError(i, "请填写手机号"), i.focus();
        try {
      ...
      if ("+86" == n.val() && !/^(1[3456789][0-9]{9})$/.test(i.val())) {
        Sign.showError(i, "请正确填写手机号"), i.focus();
        try {
          _T.sendEvent(i.closest(".sign-form").data("flow") + "_mobile")
        } catch (e) {
        }
    ...
    if (s.length) {
      if ("" == s.val()) return Sign.showError(s, "请填写密码"), s.focus(), !1;
      Sign.hideError(s)
    }
      ...
      if (e.find(".form-row-verify").length) e.find(".form-row-verify").show(); else {
        ...
        var l = new VerifyCodeSDK({
          dom: e.find(".form-row-verify")[0], success: function (i) {
            ...
            }, 500) : (e.find(".form-row-verify .picture_box").append('<button class="btn btn-img">确定</button>'), e.on("click", ".btn-img", function () {
    ...
    if (3 != VERRIFYCODETYPE) {
      if (!c.length) return e.parents(".sign-quick").length ? $.toast({
        type: "error",
        content: "请滑动完成验证"
      }) : Sign.showError(r, "请滑动完成验证"), c.focus(), !1;
      ...
      if ("" == d) return e.parents(".sign-quick").length ? $.toast({
        type: "error",
        content: "请填写图片验证码"
      }) : Sign.showError(r, "请填写图片验证码"), c.focus(), !1;
      e.find("input[name=captcha]").val(d), Sign.hideError(c)
    }
    if (!t && o.length && !o.is(":checked")) return alert("请阅读并同意BOSS直聘用户协议，方可注册"), !1;
    if (a.length && !t) {
      if ("" == a.val()) return Sign.showError(a, "请填写短信验证码"), a.focus(), !1;
      if (!a.val().match(/^.{4,6}$/)) return Sign.showError(a, "请填写正确的短信验证码"), a.focus(), !1;
      if (a.val().match(/\D+/)) return Sign.showError(a, "请填写正确的短信验证码"), a.val(""), a.focus(), !1;
      Sign.hideError(a)
    }
    Sign.postData(e, t)
  },
  ...
  dealSignResult: function (e, t, i, n, s, a) {
    ...
    if ((0 != a.code && 6 != a.code || 2 == o.type && r || 4 == o.type) && e.find(".row-code").is(":visible") && new VerifyCodeSDK({
      ...
      if (t.hasClass("sign-pwd") && Sign.callbackPwd(e, o), t.hasClass("sign-sms")) if (s) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
      ...
      if (t.hasClass("sign-register")) if (s) {
        i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
          i.html("发送验证码").removeClass("count-down btn-disabled")
      ...
      if (t.hasClass("sign-bind-wechat-signin")) if (s) if (2 == o.type) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      }), i.parent().find(".ipt-sms").focus(), 4 == o.errorType) {
        Sign.showError(e, "获取验证码过于频繁，请稍后再试", !0);
        try {
      ...
      } else Sign.showError(e, a.message, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else Sign.callbackWechatBind(e, o);
      if (t.hasClass("sign-bind-wechat-signup")) if (s) if (2 == o.type) Sign.showError(e, a.message, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else {
        i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
          i.html("发送验证码").removeClass("count-down btn-disabled")
      ...
      if (t.hasClass("sign-resume")) if (s) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      }), i.parent().find(".ipt-sms").focus(), 4 == o.errorType) {
        Sign.showError(e, "获取验证码过于频繁，请稍后再试", !0);
        try {
      ...
      if (t.hasClass("sign-quick")) if (s) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
  ...
  dealSignFail: function (e, t, i, n) {
    ...
    if (0 == n.code) {
      var a = {
        content: n.message, confirmButton: "知道了", openCallback: function (e) {
          e.$confirmButton.parent().css("text-align", "center")
        }
      };
      Sign.showConfirm(a), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click()
      ...
      i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click()
    } else if (9 == n.code) {
      ...
      i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click()
    } else if (6 == n.code) Sign.showError(e, "短信验证码错误", !0); else if (10002 == n.code) $.dialog({
      title: "",
    ...
    }), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click(); else if (400041 == n.code) $.dialog({
      title: "绑定失败",
    ...
    }), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click(); else if (n.code > 4e5 && n.code < 401e3) if (Sign.tooLongCode.indexOf(n.code)) {
      var o = "";
      switch (n.code) {
        case 400026:
      ...
      }), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val("")
    } else Sign.showError(e, n.message, !0), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""); else if (n.code > 4e3 && n.code < 5e3) if (4002 === n.code) {
    ...
    } else Sign.showError(e, n.message, !0), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""); else Sign.showError(e, n.message, !0), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val("")
  },
  dealSignResultOld: function (e, t, i, n, s, a) {
    var o = "/registe/headhunter/save.json" == e.attr("action") || "/registe/save.json" == e.attr("action");
    if ((1 != a.rescode && 6 != a.rescode || 2 == a.type && o || 4 == a.type) && e.find(".row-code").is(":visible") && new VerifyCodeSDK({
      dom: e.find(".row-code")[0],
      success: function (e) {
        Sign.VerrifySuccessCallback(e)
      },
      ...
      if (t.hasClass("sign-pwd") && Sign.callbackPwd(e, a), t.hasClass("sign-sms")) if (s) if (2 == a.type) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      ...
      } else Sign.showError(e, a.resmsg, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else Sign.callbackSms(e, a);
      if (t.hasClass("sign-register")) if (s) if (2 == a.type) Sign.showError(e, a.resmsg, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      }), i.parent().find(".ipt-sms").focus(), 4 == a.errorType) {
        Sign.showError(e, "获取验证码过于频繁，请稍后再试", !0);
        try {
      ...
      if (t.hasClass("sign-bind-wechat-signin")) if (s) if (2 == a.type) if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      }), i.parent().find(".ipt-sms").focus(), 4 == a.errorType) {
        Sign.showError(e, "获取验证码过于频繁，请稍后再试", !0);
        try {
      ...
      } else Sign.showError(e, a.resmsg, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else Sign.callbackWechatBind(e, a);
      if (t.hasClass("sign-bind-wechat-signup")) if (s) if (2 == a.type) Sign.showError(e, a.resmsg, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else {
        i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
          i.html("发送验证码").removeClass("count-down btn-disabled")
        }), i.parent().find(".ipt-sms").focus();
        try {
      ...
      if (t.hasClass("sign-quick")) if (s) if (2 == a.type) Sign.showError(e, a.resmsg, !0), i.html("发送验证码").removeClass("count-down btn-disabled"); else if (i.html('已发送 <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
        i.html("发送验证码").removeClass("count-down btn-disabled")
      }), i.parent().find(".ipt-sms").focus(), 4 == a.errorType) {
        Sign.showError(e, "获取验证码过于频繁，请稍后再试", !0);
        try {
  ...
  dealSignFailOld: function (e, t, i, n) {
    if (0 == n.rescode) {
      var s = {
        content: n.resmsg, confirmButton: "知道了", openCallback: function (e) {
          e.$confirmButton.parent().css("text-align", "center")
        }
      };
      Sign.showConfirm(s), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click()
      ...
      i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click()
    } else if (6 == n.rescode) Sign.showError(e, "短信验证码错误", !0); else if (10002 == n.rescode) $.dialog({
      title: "",
      content: '<div style="padding: 4px 0 30px;">请切换至牛人身份，再重新尝试</div>',
      type: "error",
      closeText: !0,
    ...
    }), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click(); else if (400041 == n.rescode) $.dialog({
      title: "绑定失败",
      content: "当前BOSS直聘账号已绑定过微信，可直接使用关联的微信扫码登录",
      closeText: !0,
      cancelText: "",
    ...
    }), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click(); else if (n.rescode > 4e5 && n.rescode < 401e3) if (400031 == n.rescode) Sign.showError(e, n.resmsg, !0); else {
      var a = "";
      switch (n.rescode) {
        case 400026:
    ...
    } else Sign.showError(e, n.resmsg, !0), i && t.html("发送验证码").removeClass("btn-disabled"), e.find(".ipt-code").val("")
  },
  ...
  callbackWechatBindRegister: function (e, t) {
    ...
    if (e.closest(".pop-sign-box").length && (i = e.closest(".pop-sign-box")), t.toUrl) {
      $.toast({content: "注册成功，正在为您跳转到完善页面", type: "success"});
      var a = "";
      a = -1 != t.toUrl.indexOf("http") ? t.toUrl : "https://www.zhipin.com" + t.toUrl, window.location.href = decodeURIComponent(a)
    } else Sign.source ? ($.toast({content: "注册成功", type: "success"}), setTimeout(function () {
  ...
  callbackRegister: function (e, t) {
    ...
    if (e.closest(".pop-sign-box").length && (i = e.closest(".pop-sign-box")), t.toUrl) {
      $.toast({content: "注册成功，自动跳转完善页面", type: "success"});
      var a = "";
      a = -1 != t.toUrl.indexOf("http") ? t.toUrl : "https://www.zhipin.com" + t.toUrl, window.location.href = decodeURIComponent(a)
    } else {
  ...
  callbackCheckRegister: function (e, t) {
    ...
    var i = e.parents(".login-wechat").find(".bind-box"), n = i.find("form"), s = i.find('form .btn[type="submit"]');
    e.parents(".login-wechat .register-box").addClass("hide"), i.removeClass("hide"), i.find(".ipt-phone").val(t.account), Sign.init(i), t.isRegistered ? (n.attr("action", "/login/headhunter/phone.json"), n.find('input[name="smsType"]').val(4), s.text("登录，并绑定手机号")) : (n.attr("action", "/registe/headhunter/save.json"), n.parents(".sign-form").removeClass(".sign-sms"), n.find('input[name="smsType"]').val(5), s.text("注册"), n.parents(".sign-form").removeClass("sign-sms").addClass("sign-register"))
  },
  ...
  showError: function (e, t, i) {
    ...
    if (s.length || (s = n.find(".tip-error-form")), s.length || (s = n.find(".tip-error").eq(0)), s.text(t).show(), "短信验证码错误" == t && n.find(".ipt-sms").focus().val(""), i) try {
  ...
  scanLogin: function (e, t, i, n) {
    ...
    $.ajax({
      ...
      timeout: 1e5,
      success: function (i) {
        if (i.scaned) if (i.login) $(".sign-scan .login-step-text .login-step-title").text("正在登录..."), $(".sign-scan .login-step-text .login-step-detail").hide(), Sign.scanJump(e, t, i, n); else {
  ...
  URL: {
    ...
    if (!t.hasClass("disabled")) {
      ...
      $.ajax({
        ...
        data: {status: e},
        success: function (n) {
          1 == n.rescode ? (i.showModalToast("设置成功", "success"), i.switchSuccessFn(e, t)) : 0 == n.rescode && i.showModalToast(n.resmsg, "error"), t.removeClass("disabled")
        },
        error: function () {
    ...
    var i = t.parents(".switch-op").siblings("p.gray"),
      n = {0: "招呼语已关闭，系统将不再为您发出打招呼语，您可能会收到更少Boss的回复", 1: "选择一个招呼语，在您和Boss发起聊天时，系统为您自动发出"};
    if (0 == e) {
    ...
    $(".account-container .sayhello-form").on("change", ".radio-list .radio input", function () {
      ...
      t.find(".defined-form").addClass("show-defined-form"), t.find(".btn-remove").hide(), t.find('.defined-form input[name="templateId"]').val(""), t.find(".defined-form .ipt-area").text("").val("").focus(), $(window).scrollTop($(".account-container").height()), e.countArea(i), t.find(".defined-form .tip-text").text("请不要填写手机、QQ、微信等联系方式或广告信息，否则系统将封禁您的账号！")
    }), t.on("click", ".link-modify", function () {
      var n = $(this).closest("li").find("span").text();
      t.find(".defined-form").addClass("show-defined-form"), t.find(".defined-form .ipt-area").focus(), i.text(n).val(n), t.find('input[name="templateId"]').val($(this).closest("li").find('input[name="sendMsg"]').val()), t.find(".btn-remove").show(), $(window).scrollTop($(".account-container").height()), e.countArea(i), t.find(".defined-form .tip-text").text("请不要填写手机、QQ、微信等联系方式或广告信息，否则系统将封禁您的账号！")
    }), i.on("input", function () {
      e.countArea($(this))
    ...
    $(".account-container .set-usalbox").on("click", ".op-sentence .link-add", function () {
      $(this).closest("dl").find(".defined-form").addClass("show-defined-form"), $(this).closest("dl").find(".defined-form .ipt-area").focus(), $(this).closest("dl").find(".defined-form .tip-text").text("请不要填写手机、QQ、微信等联系方式或广告信息，否则系统将封禁您的账号！"), $(window).scrollTop($(".account-container").height()), $(this).closest("dl").find(".count-num").length && e.countArea($(this).closest("dl").find(".ipt-area"))
      ...
      if ($(this).hasClass("btn-back")) $(this).closest("dl").find(".defined-form").removeClass("show-defined-form"), $(".account-container .defined-form .ipt-area").val(""); else {
        if ("" == $(this).closest("dl").find(".defined-form .ipt-area").val().replace(/(\s*$)/g, "")) return $(this).closest("dl").find(".defined-form .tip-text").text("请输入正确的常用语"), $(this).closest("dl").find(".defined-form .ipt-area").focus(), !1;
        if ($(this).closest("dl").find(".defined-form .count-num .red").length) return $(this).closest("dl").find(".defined-form .tip-text").text("常用语不能超过200个字"), $(this).closest("dl").find(".defined-form .ipt-area").focus(), !1;
    ...
    return t.find(".ipt-area").val(t.find(".ipt-area").val().replace(/(^[\s\n\r]*)|([\s\n\r]*$)/g, "")), "" == t.find(".ipt-area").val().replace(/(\s*$)/g, "") ? (t.find(".tip-text").text("请输入正确的打招呼语"), t.find(".ipt-area").focus(), !1) : t.find(".count-num .red").length ? (t.find(".tip-text").text("打招呼语不能超过60个字"), t.find(".ipt-area").focus(), !1) : !e.hasClass("disabled") && (e.addClass("disabled"), void $.ajax({
      url: i, type: "POST", data: n, dataType: "JSON", timeout: 3e4, success: function (i) {
        ...
        e.removeClass("disabled"), t.find(".tip-text").text("请不要填写手机、QQ、微信等联系方式或广告信息，否则系统将封禁您的账号！")
      }, error: function (i) {
        e.removeClass("disabled"), t.find(".tip-text").text("请不要填写手机、QQ、微信等联系方式或广告信息，否则系统将封禁您的账号！"), $.toast({
    ...
    $.dialog({
      ...
      onConfirm: function (i) {
        ...
        $.ajax({
          ...
          error: function (e) {
            $.toast({content: "删除失败，请稍后再试", type: "error"}), i.remove()
          }
        })
      },
      onClose: function (e) {
    ...
    $(".get-message-code").on("click", function () {
      ...
      if (t && i) {
        ...
        $.ajax({
          ...
          success: function (t) {
            if (1 == t.rescode) $(".get-message-code").html('<em class="num">60s</em> 后重试').addClass("count-down"), e.countDown($(".count-down"), function () {
          ...
          error: function () {
            $.toast({content: "网络错误修改失败", lock: !0, type: "error", wrapClass: "", position: "top", time: 3e3})
          }
        })
      }
    })
    ...
    return e.removeError($(".ipt-pwd-orginal")), t.length ? !!/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$/.test(t) || (e.showError($(".ipt-pwd-orginal"), "请设置6-20位数字与字母组合密码"), $(".ipt-pwd-orginal").val(""), $(".ipt-pwd-orginal").focus(), !1) : (e.removeError($(".ipt-pwd-orginal")), e.showError($(".ipt-pwd-orginal"), "请输入密码"), !1)
  }, pwdConfirmAgain: function () {
    var e = this, t = $(".ipt-pwd-orginal-confirm").val(), i = $(".ipt-pwd-orginal").val();
    return e.removeError($(".ipt-pwd-orginal-confirm")), t.length ? i === t || (e.showError($(".ipt-pwd-orginal-confirm"), "两次输入密码不一致"), $(".ipt-pwd-orginal-confirm").focus(), !1) : (e.removeError($(".ipt-pwd-orginal-confirm")), e.showError($(".ipt-pwd-orginal-confirm"), "请重复输入密码"), !1)
  }, oldPassword: function () {
    var e = this, t = $(".ipt-pwd-old");
    return e.removeError(t), !!t.val().length || (e.showError(t, "请输入旧密码"), t.focus(), !1)
  }, newPassword: function () {
    var e = this, t = $(".ipt-pwd-new");
    $(".ipt-pwd-old").val();
    e.removeError(t);
    var i = t.val();
    return i.length ? !!/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$/.test(i) || (e.showError(t, "请设置6-20位数字与字母组合密码"), t.focus(), !1) : (e.showError(t, "请输入新密码"),
      t.focus(), !1)
...
var QuickSign = {
  init: function () {
        ...
        if (!$(this).hasClass("btn-disabled")) {
          ...
          if ("" != t && /^(1[3456789][0-9]{9})$/.test(t)) {
            ...
            QuickSign.Verify = new VerifyCodeSDK({
              dom: $(".code-form-box .row-code")[0], success: function (e) {
                QuickSign.VerrifySuccessCallback(e)
              }, ready: function (e) {
                QuickSign.VerrifyReadyCallback(e)
              }
            })
          } else $.toast({content: "请输入正确的手机号", type: "warning"})
        }
    ...
    if (t.isCompletion) if (t.toUrl) {
      ...
      var o = t.autoRegister ? "注册成功，正在为您跳转到完善页面" : "登录成功，正在为您跳转到完善页面";
    ...
    var e = e, i = e.find(".ipt-phone"), n = e.find(".ipt-sms"), s = "";
    if (1 == QuickSign.VERRIFYCODETYPE ? s = e.find("input[name=challenge]") : 2 == QuickSign.VERRIFYCODETYPE && (s = e.find("input[name=csessionId]")), i.length) {
      if ("" == i.val()) {
        $.toast({content: "请输入正确的手机号", type: "warning"}), i.focus();
        try {
          _T.sendEvent(i.closest(".sign-form").data("flow") + "_mobile")
        } catch (e) {
        }
    ...
    if (3 != QuickSign.VERRIFYCODETYPE) {
      if (s.length) {
        if ("" == s.val()) return $.toast({content: "请滑动完成验证", type: "warning"}), s.focus(), !1;
        Sign.hideError(s)
      }
    } else {
      var s = e.find(".input_code"), a = s.val();
      if ("" == a) return $.toast({content: "请填写图片验证码", type: "warning"}), s.focus(), !1;
      e.find("input[name=captcha]").val(a), Sign.hideError(s)
    }
    if (n.length && !t) {
      if ("" == n.val()) return $.toast({content: "请填写短信验证码", type: "warning"}), n.focus(), !1;
      if (!n.val().match(/^.{4,6}$/)) return $.toast({content: "短信验证码错误", type: "warning"}), n.focus(), !1;
      if (n.val().match(/\D+/)) return $.toast({content: "短信验证码错误", type: "warning"}), n.val(""), n.focus(), !1
    }
    ...
    if (isSms) {
      if (btnSms.hasClass("btn-disabled")) return;
      url = btnSms.attr("data-url"), btnSms.addClass("btn-disabled").html("稍后")
    } else {
      if (btnEl.hasClass("btn-disabled")) return;
      btnEl.addClass("btn-disabled")
    }
    $.ajax({
      url: url, type: "post", dataType: "json", data: formEl.serialize(), success: function (result) {
        ...
        if (0 !== result.code && new VerifyCodeSDK({
          ...
          type: "warning"
        }), btnSms.html("获取").removeClass("count-down btn-disabled"); else {
          $.toast({
            content: "短信验证码已发送",
            type: "success"
          ...
          content: result.message,
          type: "warning"
        }), isSms && btnSms.html("获取").removeClass("btn-disabled"), formEl.find(".ipt-code").val(""), formEl.find(".verifyimg").click()) : 6 == result.code ? $.toast({
          content: "短信验证码错误",
          type: "warning"
        }) : ($.toast({
          content: result.message,
...
var Settings = {
  init: function () {
    ...
    var t = e.html();
    $.dialog({
      title: "", wrapClass: "layer-privacy", confirmText: "", cancelText: "", content: t, onOpen: function (e) {
    ...
    Settings.post("/autocomplete/maskcompany.json", {searchContent: e}).then(function (n) {
      ...
      if (s.length) {
        for (var c = 0; c < s.length; c++) s[c].mark ? o += '<li data-id="' + s[c].encryptComId + '">\t\t\t\t\t\t\t<label class="checkbox">\t\t\t\t\t\t\t\t<span class="gray">已屏蔽</span>\t\t\t\t\t\t\t</label>\t\t\t\t\t\t\t<div class="company-name">\t\t\t\t\t\t\t\t<p>' + s[c].company.name + '</p>\t\t\t\t\t\t\t\t<p class="gray">' + (null == s[c].desc ? "" : s[c].desc.hlname) + "</p>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</li>" : (o += '<li data-id="' + s[c].encryptComId + '">\t\t\t\t\t\t\t<label class="checkbox">\t\t\t\t\t\t\t\t<input type="checkbox" checked="checked">\t\t\t\t\t\t\t\t<span></span>\t\t\t\t\t\t\t</label>\t\t\t\t\t\t\t<div class="company-name">\t\t\t\t\t\t\t\t<p>' + s[c].company.name + '</p>\t\t\t\t\t\t\t\t<p class="gray">' + (null == s[c].desc ? "" : s[c].desc.hlname) + "</p>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</li>", r = "");
      ...
      i.html(a), i.find(".check-all input").on("change", function () {
        ...
        if (!$(this).hasClass("disabled")) {
          ...
          if (i.find(".result-list li").each(function () {
            ...
            $(this).prev("span").remove(), $(this).before("<span>至少选择一个公司</span>")
          }
        }
      });
      try {
    ...
    Settings.page++, $.get(i, {page: Settings.page}, function (i) {
      if (i.rescode) {
        for (var s = i.maskCompanyList, a = 0; a < s.length; a++) n += '<li><span class="link-cancel" data-id="' + s[a].encryptComId + '">取消屏蔽</span>' + s[a].comName + "</li>";
        i.hasMore || e.text("没有更多了").addClass("disabled"), t.append(n)
      }
    })
  }
};
...
preview.init(), $(function () {
  if ($("#competitive-main").length) {
    ...
    _COMPETITIVE_PAGE.reportDataJson || (_COMPETITIVE_PAGE.reportDataJson = _COMPETITIVE_PAGE.data), _COMPETITIVE_PAGE.reportDataJson.General_Market.forEach(function (t) {
      ...
      animation: !1,
      series: [{name: "市场水平", data: e, pointPlacement: "on", color: "rgb(188,249,232)"}, {
        name: "您的情况",
        data: t,
        pointPlacement: "on",
...
$(document).ready(function () {
  ...
  if ($("#competitive-main").length) {
    window.ids = [{id: "Comm_Interview", width: 0, height: 0, excute: !1}, {
      ...
      height: 0,
      excute: !1
    }, {id: "Salary_SuperMax", width: 0, height: 0, excute: !1}, {id: "container", width: 0, height: 0, excute: !1}];
    var i = function (e) {
    ...
    $(window).scroll(n(200, e)), n(200, e)(), _COMPETITIVE_PAGE.reportDataJson.Communicate.forEach(function (e, t, i) {
      ...
      if (ids.map(function (t) {
        ...
        0 == o && $("#contract").html("1%").prev("span").html("超过了"), o < 50 && o > 0 && $("#contract").html(parseInt(o) + "%").prev("span").html("超过了"), o >= 50 && 100 - o != 0 && $("#contract").html(parseInt(100 - o) + "%").prev("span").html("排名前")
      } else 0 == t && (o = 100);
      ...
      if (height = e.rate * a / 100, ids.map(function (t) {
        ...
        0 == s && $("#CVMatch").html("1%").prev("span").html("超过了"), s < 50 && s > 0 && $("#CVMatch").html(parseInt(s) + "%").prev("span").html("超过了"), s >= 50 && 100 - s != 0 && $("#CVMatch").html(+parseInt(100 - s) + "%").prev("span").html("排名前")
      } else 0 == t && (s = 100);
      ...
      if (ids.map(function (t) {
        ...
        0 == s && $("#Degree").html("1%").prev("span").html("超过了"), s < 50 && s > 0 && $("#Degree").html(+parseInt(s) + "%").prev("span").html("超过了"), s >= 50 && 100 - s != 0 && $("#Degree").html(+parseInt(100 - s) + "%").prev("span").html("排名前")
      } else 0 == t && (s = 100);
      ...
      if (ids.map(function (t) {
        ...
        for (var r = t - 1; r >= 0; r--) s += i[r].rate;
        0 == s && $("#Experience").html("1%").prev("span").html("超过了"), s < 50 && s > 0 && $("#Experience").html(+parseInt(s) + "%").prev("span").html("超过了"), s >= 50 && 100 - s != 0 && $("#Experience").html(+parseInt(100 - s) + "%").prev("span").html("排名前")
      } else 0 == t && (s = 100);
      ...
      if (height = e.rate * a / 100, ids.map(function (t) {
        ...
        for (var o = t - 1; o >= 0; o--) s += i[o].rate;
        0 == s && $("#Salary_Dynamic").html("1%").prev("span").html("超过了"), s < 50 && s > 0 && $("#Salary_Dynamic").html(+parseInt(s) + "%").prev("span").html("超过了"), s >= 50 && 100 - s != 0 && $("#Salary_Dynamic").html(+parseInt(100 - s) + "%").prev("span").html("排名前"), $("#Salary_Dynamic + p").html(text[e.factor])
      } else 0 == t && (s = 100);
      100 - s == 0 && $("#Salary_Dynamic").html("1%").prev("span").html("超过了"), e.isCur && "Salary_NO" == e.factor && $("#Salary_Dynamic").html(e.rate + "%").prev("span").html("未填写")
    });
    ...
    _COMPETITIVE_PAGE.reportDataJson.Boss_Active.forEach(function (e, t) {
      ...
      if (e.isCur) {
        ...
        $("#Boss_Active").html("Boss活跃情况：" + e.name + n), $("#Boss_Active-text").html(text[e.factor])
    ...
    _COMPETITIVE_PAGE.reportDataJson.Job_Hot_Degree.forEach(function (e, t) {
      ...
      if (e.isCur) {
        ...
        $("#Job_Hot_Degree").html("职位热度：" + e.name + n), $("#Job_Hot_Degree-text").html(text[e.factor])
      } else $(i).attr("src", a), $(i).hasClass("no_active") || $(i).addClass("no_active"), $(i).hasClass("active") && $(i).removeClass("active")
    });
    ...
    }), _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum > .5 && 1 - _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum != 0 && $("#rank").html("个人综合竞争力：超过了" + parseInt(100 * (1 - _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum)) + "%"), _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum < .5 && _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum > 0 && $("#rank").html("个人综合竞争力：排名前" + parseInt(100 * _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum) + "%的人"), (_COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum == 0 || 1 - _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum == 0) && $("#rank").html("个人综合竞争力：超过了1%的人"), $(".work_card").click(function (e) {
      var t = $(this).data("url");
      t && (window.location.href = t)
    }), _COMPETITIVE_PAGE.hasFriendRelation || ($(".start-chat").show(), $(".sub").html("立即沟通"), $(".start-chat").on("click", function () {
      Detail.startChat($(this))
    })), $(".competitive-time").html("评估时间：" + (new Date).toISOString().slice(0, 10)), $(".evaluate_time").html("评估时间：" + (new Date).toISOString().slice(0, 10)), setTimeout(function () {
...
var ItemShop = function () {
  ...
  var t = {
    ...
    analyzer: function (e) {
      return Utemplate('<div class="analyzer-head"><i class="icon-logo"></i><div><h4><%this.itemName%></h4><%this.itemNote%></div></div><ul class="analyzer-list"><li><div class="analyzer-item"><p class="icon-item icon-compete"></p><p>知己知彼</p><p class="gray">洞悉求职胜算</p></div><div class="analyzer-item"><p class="icon-item icon-compete-hover"></p></div></li><li><div class="analyzer-item"><p class="icon-item icon-expect"></p><p>了解薪资水平</p><p class="gray">查看期望薪资占比</p></div><div class="analyzer-item"><p class="icon-item icon-expect-hover"></p><p>期望薪资占比</p><p class="gray">让BOSS认可你，才能匹配好的薪资</p></div></li><li><div class="analyzer-item"><p class="icon-item icon-active"></p><p>实时招聘动态</p><p class="gray">了解职位近90天数据</p></div><div class="analyzer-item"><p class="icon-item icon-active-hover"></p><p>BOSS活跃情况</p><p class="gray">BOSS对该职位需求非常紧急</p></div></li></ul><dl class="analyzer-combo-list"><dt ka="item_pay_buy_competitive_chat">立即购买</dt><%for(var i=0;i<this.itemSellItemList.length;i++){%><dd <%if(i== 2){%>class="discount selected"<%}%> data-id="<%this.itemSellItemList[i].encryptBeanItemId%>"><%this.itemSellItemList[i].specDesc%><i class="line"></i><%this.itemSellItemList[i].beanAmount%>直豆</dd><%}%></dl>', e)
    }
  };
  return {
    analyzer: e, personality: function (e) {
      var t = function () {
        Payment.success({
          article: "购买成功", text: "", confirmText: "立即使用", confirm: function (t) {
            e && e(t)
          }
        })
      }, i = {
...
$(function () {
  if ($(".satisfaction-feedback").length || $(".satisfaction-feedback .satisfaction").length) {
    ...
    e.find("textarea").on("input", function () {
      if (Validate.getLength($(this).val()) > 150) return $.toast({type: "error", content: "不超过150个汉字"}), !1
      ...
      add: function (e, t) {
        ...
        switch ("string" == typeof result && (result = eval("(" + result + ")")), result.code) {
          ...
          case 24:
            ...
            break;
          case 200214:
            $.toast({content: "牛人身份已完善，即将为你跳转个人中心页", type: "info"}), setTimeout(function () {
